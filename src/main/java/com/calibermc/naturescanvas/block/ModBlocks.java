...
import com.calibermc.naturescanvas.item.CreativeTab;
import com.calibermc.naturescanvas.item.ModItems;
...
//                    .strength(2f).requiresCorrectToolForDrops()), CreativeTab.NATURESCANVAS_TAB);
    ...
    public static final RegistryObject<Block> DARK_LIMESTONE_BUTTON = registerBlock("dark_limestone_button",
            () -> new StoneButtonBlock(BlockBehaviour.Properties.of(Material.STONE)
                    .strength(1.5f).requiresCorrectToolForDrops().noCollission()), CreativeTab.NATURESCANVAS_TAB);
    ...
    public static final RegistryObject<Block> BLACK_SAND = registerBlock("black_sand",
            () -> new Block(BlockBehaviour.Properties.of(Material.SAND)
                    .strength(0.5f).requiresCorrectToolForDrops()), CreativeTab.NATURESCANVAS_TAB);
