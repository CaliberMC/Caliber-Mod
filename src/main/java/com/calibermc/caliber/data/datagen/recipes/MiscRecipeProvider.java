...
public class MiscRecipeProvider extends RecipeProvider implements IConditionBuilder {
    ...
    private void bopRecipes(Consumer<FinishedRecipe> pFinishedRecipeConsumer) {
        ...
        ShapedRecipeBuilder.shaped(RecipeCategory.REDSTONE, BiomesOPlentyBlocks.BOP_DEAD.get(ModBlockFamily.Variant.TALL_DOOR), 1).define('X', BOPBlocks.DEAD_DOOR).define('#', BiomesOPlentyBlocks.BOP_DEAD.baseBlock()).pattern("X").pattern("#").unlockedBy("has_bop_dead",
        ...
        ShapedRecipeBuilder.shaped(RecipeCategory.REDSTONE, BiomesOPlentyBlocks.BOP_FIR.get(ModBlockFamily.Variant.TALL_DOOR), 1).define('X', BOPBlocks.FIR_DOOR).define('#', BiomesOPlentyBlocks.BOP_FIR.baseBlock()).pattern("X").pattern("#").unlockedBy("has_fir",
        ...
        ShapedRecipeBuilder.shaped(RecipeCategory.REDSTONE,  BiomesOPlentyBlocks.BOP_HELLBARK.get(ModBlockFamily.Variant.TALL_DOOR), 1).define('X', BOPBlocks.HELLBARK_DOOR).define('#', BiomesOPlentyBlocks.BOP_HELLBARK.baseBlock()).pattern("X").pattern("#").unlockedBy("has_bop_hellbark",
        ...
        ShapedRecipeBuilder.shaped(RecipeCategory.REDSTONE,  BiomesOPlentyBlocks.BOP_JACARANDA.get(ModBlockFamily.Variant.TALL_DOOR), 1).define('X', BOPBlocks.JACARANDA_DOOR).define('#', BiomesOPlentyBlocks.BOP_JACARANDA.baseBlock()).pattern("X").pattern("#").unlockedBy("has_bop_jacaranda",
        ...
        ShapedRecipeBuilder.shaped(RecipeCategory.REDSTONE,  BiomesOPlentyBlocks.BOP_MAGIC.get(ModBlockFamily.Variant.TALL_DOOR), 1).define('X', BOPBlocks.MAGIC_DOOR).define('#', BiomesOPlentyBlocks.BOP_MAGIC.baseBlock()).pattern("X").pattern("#").unlockedBy("has_bop_magic",
        ...
        ShapedRecipeBuilder.shaped(RecipeCategory.REDSTONE,  BiomesOPlentyBlocks.BOP_MAHOGANY.get(ModBlockFamily.Variant.TALL_DOOR), 1).define('X', BOPBlocks.MAHOGANY_DOOR).define('#', BiomesOPlentyBlocks.BOP_MAHOGANY.baseBlock()).pattern("X").pattern("#").unlockedBy("has_bop_mahogany",
        ...
        ShapedRecipeBuilder.shaped(RecipeCategory.REDSTONE,  BiomesOPlentyBlocks.BOP_PALM.get(ModBlockFamily.Variant.TALL_DOOR), 1).define('X', BOPBlocks.PALM_DOOR).define('#', BiomesOPlentyBlocks.BOP_PALM.baseBlock()).pattern("X").pattern("#").unlockedBy("has_bop_palm",
        ...
        ShapedRecipeBuilder.shaped(RecipeCategory.REDSTONE,  BiomesOPlentyBlocks.BOP_REDWOOD.get(ModBlockFamily.Variant.TALL_DOOR), 1).define('X', BOPBlocks.REDWOOD_DOOR).define('#', BiomesOPlentyBlocks.BOP_REDWOOD.baseBlock()).pattern("X").pattern("#").unlockedBy("has_bop_redwood",
        ...
        ShapedRecipeBuilder.shaped(RecipeCategory.REDSTONE,  BiomesOPlentyBlocks.BOP_UMBRAN.get(ModBlockFamily.Variant.TALL_DOOR), 1).define('X', BOPBlocks.UMBRAN_DOOR).define('#', BiomesOPlentyBlocks.BOP_UMBRAN.baseBlock()).pattern("X").pattern("#").unlockedBy("has_bop_umbran",
        ...
        ShapedRecipeBuilder.shaped(RecipeCategory.REDSTONE,  BiomesOPlentyBlocks.BOP_WILLOW.get(ModBlockFamily.Variant.TALL_DOOR), 1).define('X', BOPBlocks.WILLOW_DOOR).define('#', BiomesOPlentyBlocks.BOP_WILLOW.baseBlock()).pattern("X").pattern("#").unlockedBy("has_bop_willow",
