...
public class ItemRecipeProvider extends RecipeProvider implements IConditionBuilder {
    ...
    private void armorRecipes(Consumer<FinishedRecipe> pFinishedRecipeConsumer) {
        /* Armor */
        ShapedRecipeBuilder.shaped(RecipeCategory.COMBAT, ModItems.BRONZE_BOOTS.get(), 1).define('I', ModItems.BRONZE_INGOT.get()).pattern("I I").pattern("I I").unlockedBy("has_bronze_ingot",
        ...
        ShapedRecipeBuilder.shaped(RecipeCategory.COMBAT, ModItems.BRONZE_CHESTPLATE.get(), 1).define('I', ModItems.BRONZE_INGOT.get()).pattern("I I").pattern("III").pattern("III").unlockedBy("has_bronze_ingot",
        ...
        ShapedRecipeBuilder.shaped(RecipeCategory.COMBAT, ModItems.BRONZE_HELMET.get(), 1).define('I', ModItems.BRONZE_INGOT.get()).pattern("III").pattern("I I").unlockedBy("has_bronze_ingot",
        ...
        ShapedRecipeBuilder.shaped(RecipeCategory.COMBAT, ModItems.BRONZE_LEGGING.get(), 1).define('I', ModItems.BRONZE_INGOT.get()).pattern("III").pattern("I I").pattern("I I").unlockedBy("has_bronze_ingot",
    ...
    private void toolRecipes(Consumer<FinishedRecipe> pFinishedRecipeConsumer) {
        /* Tools */
        ShapedRecipeBuilder.shaped(RecipeCategory.TOOLS, ModItems.BRONZE_AXE.get(), 1).define('I', ModItems.BRONZE_INGOT.get()).define('#', Items.STICK).pattern("II ").pattern("I# ").pattern(" # ").unlockedBy("has_bronze_ingot",
        ...
        ShapedRecipeBuilder.shaped(RecipeCategory.TOOLS, ModItems.BRONZE_HOE.get(), 1).define('I', ModItems.BRONZE_INGOT.get()).define('#', Items.STICK).pattern("II ").pattern(" # ").pattern(" # ").unlockedBy("has_bronze_ingot",
        ...
        ShapedRecipeBuilder.shaped(RecipeCategory.TOOLS, ModItems.BRONZE_PICKAXE.get(), 1).define('I', ModItems.BRONZE_INGOT.get()).define('#', Items.STICK).pattern("III").pattern(" # ").pattern(" # ").unlockedBy("has_bronze_ingot",
        ...
        ShapedRecipeBuilder.shaped(RecipeCategory.TOOLS, ModItems.BRONZE_SHOVEL.get(), 1).define('I', ModItems.BRONZE_INGOT.get()).define('#', Items.STICK).pattern(" I ").pattern(" # ").pattern(" # ").unlockedBy("has_bronze_ingot",
    ...
    private void weaponRecipes(Consumer<FinishedRecipe> pFinishedRecipeConsumer) {
        /* Weapons */
        ShapedRecipeBuilder.shaped(RecipeCategory.COMBAT, ModItems.BRONZE_SWORD.get(), 1).define('I', ModItems.BRONZE_INGOT.get()).define('#', Items.STICK).pattern(" I ").pattern(" I ").pattern(" # ").unlockedBy("has_bronze_ingot",
