...
//        models().buttonInventory("stained_spruce_button", blockTexture(ModBlocks.STAINED_SPRUCE_BUTTON.get()));
        ...
        buttonBlock((WoodButtonBlock) ModBlocks.STAINED_ACACIA_BUTTON.get(), modLoc("block/stained_acacia_planks"));
        buttonBlock((WoodButtonBlock) ModBlocks.STAINED_BIRCH_BUTTON.get(), modLoc("block/stained_birch_planks"));
        buttonBlock((WoodButtonBlock) ModBlocks.STAINED_DARK_OAK_BUTTON.get(), modLoc("block/stained_dark_oak_planks"));
        buttonBlock((WoodButtonBlock) ModBlocks.STAINED_JUNGLE_BUTTON.get(), modLoc("block/stained_jungle_planks"));
        buttonBlock((WoodButtonBlock) ModBlocks.STAINED_OAK_BUTTON.get(), modLoc("block/stained_oak_planks"));
        buttonBlock((WoodButtonBlock) ModBlocks.STAINED_SPRUCE_BUTTON.get(), modLoc("block/stained_spruce_planks"));
