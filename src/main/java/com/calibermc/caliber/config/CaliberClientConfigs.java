...
//    public static final ForgeConfigSpec.BooleanValue SORT_CREATIVE_INVENTORY;
...
//        SORT_CREATIVE_INVENTORY = BUILDER.comment("Sort Creative Inventory Alphabetically?").translation("config.caliber.sort_creative_inventory").define("sort_creative_inventory", false);
