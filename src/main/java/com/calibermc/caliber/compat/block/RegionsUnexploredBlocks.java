...
public class RegionsUnexploredBlocks {
    ...
    /* Planks */
    public static final BlockManager RU_BAOBAB = CaliberBlockManager.registerRU("baobab_planks", () -> BlockBehaviour.Properties.copy(RuBlocks.BAOBAB_PLANKS.get()), () -> RuBlocks.BAOBAB_PLANKS.get(), COMPAT_PLANK_VARIANTS);
    public static final BlockManager RU_BLACKWOOD = CaliberBlockManager.registerRU("blackwood_planks", () -> BlockBehaviour.Properties.copy(RuBlocks.BLACKWOOD_PLANKS.get()), () -> RuBlocks.BLACKWOOD_PLANKS.get(), COMPAT_PLANK_VARIANTS);
    ...
    public static final BlockManager RU_BRIMWOOD = CaliberBlockManager.registerRU("brimwood_planks", () -> BlockBehaviour.Properties.copy(RuBlocks.BRIMWOOD_PLANKS.get()), () -> RuBlocks.BRIMWOOD_PLANKS.get(), COMPAT_PLANK_VARIANTS);
    ...
    public static final BlockManager RU_CYPRESS = CaliberBlockManager.registerRU("cypress_planks", () -> BlockBehaviour.Properties.copy(RuBlocks.CYPRESS_PLANKS.get()), () -> RuBlocks.CYPRESS_PLANKS.get(), COMPAT_PLANK_VARIANTS);
    public static final BlockManager RU_DEAD = CaliberBlockManager.registerRU("dead_planks", () -> BlockBehaviour.Properties.copy(RuBlocks.DEAD_PLANKS.get()), () -> RuBlocks.DEAD_PLANKS.get(), COMPAT_PLANK_VARIANTS);
    public static final BlockManager RU_EUCALYPTUS = CaliberBlockManager.registerRU("eucalyptus_planks", () -> BlockBehaviour.Properties.copy(RuBlocks.EUCALYPTUS_PLANKS.get()), () -> RuBlocks.EUCALYPTUS_PLANKS.get(), COMPAT_PLANK_VARIANTS);
    ...
    public static final BlockManager RU_JOSHUA = CaliberBlockManager.registerRU("joshua_planks", () -> BlockBehaviour.Properties.copy(RuBlocks.JOSHUA_PLANKS.get()), () -> RuBlocks.JOSHUA_PLANKS.get(), COMPAT_PLANK_VARIANTS);
    ...
    public static final BlockManager RU_LARCH = CaliberBlockManager.registerRU("larch_planks", () -> BlockBehaviour.Properties.copy(RuBlocks.LARCH_PLANKS.get()), () -> RuBlocks.LARCH_PLANKS.get(), COMPAT_PLANK_VARIANTS);
    ...
    public static final BlockManager RU_MAPLE = CaliberBlockManager.registerRU("maple_planks", () -> BlockBehaviour.Properties.copy(RuBlocks.MAPLE_PLANKS.get()), () -> RuBlocks.MAPLE_PLANKS.get(), COMPAT_PLANK_VARIANTS);
    public static final BlockManager RU_MAUVE = CaliberBlockManager.registerRU("mauve_planks", () -> BlockBehaviour.Properties.copy(RuBlocks.MAUVE_PLANKS.get()), () -> RuBlocks.MAUVE_PLANKS.get(), COMPAT_PLANK_VARIANTS);
    public static final BlockManager RU_PALM = CaliberBlockManager.registerRU("palm_planks", () -> BlockBehaviour.Properties.copy(RuBlocks.PALM_PLANKS.get()), () -> RuBlocks.PALM_PLANKS.get(), COMPAT_PLANK_VARIANTS);
    public static final BlockManager RU_PINE = CaliberBlockManager.registerRU("pine_planks", () -> BlockBehaviour.Properties.copy(RuBlocks.PINE_PLANKS.get()), () -> RuBlocks.PINE_PLANKS.get(), COMPAT_PLANK_VARIANTS);
    ...
    public static final BlockManager RU_REDWOOD = CaliberBlockManager.registerRU("redwood_planks", () -> BlockBehaviour.Properties.copy(RuBlocks.REDWOOD_PLANKS.get()), () -> RuBlocks.REDWOOD_PLANKS.get(), COMPAT_PLANK_VARIANTS);
    ...
    public static final BlockManager RU_WILLOW = CaliberBlockManager.registerRU("willow_planks", () -> BlockBehaviour.Properties.copy(RuBlocks.WILLOW_PLANKS.get()), () -> RuBlocks.WILLOW_PLANKS.get(), COMPAT_PLANK_VARIANTS);
