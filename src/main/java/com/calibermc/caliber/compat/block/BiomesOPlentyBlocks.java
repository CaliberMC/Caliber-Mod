...
public class BiomesOPlentyBlocks {
    ...
    /* Stone */
    public static final BlockManager BOP_BLACK_SANDSTONE = CaliberBlockManager.registerBOP("black_sandstone", () -> BlockBehaviour.Properties.copy(BOPBlocks.BLACK_SANDSTONE.get()), () -> BOPBlocks.BLACK_SANDSTONE.get(), STONE_VARIANTS_WITHOUT_SLAB_STAIRS_WALL);
    ...
    public static final BlockManager BOP_BRIMSTONE_BRICK = CaliberBlockManager.registerBOP("brimstone_bricks", () -> BlockBehaviour.Properties.copy(BOPBlocks.BRIMSTONE_BRICKS.get()), () -> BOPBlocks.BRIMSTONE_BRICKS.get(), STONE_VARIANTS_WITHOUT_SLAB_STAIRS_WALL);
    ...
    public static final BlockManager BOP_SMOOTH_BLACK_SANDSTONE = CaliberBlockManager.registerBOP("smooth_black_sandstone", () -> BlockBehaviour.Properties.copy(BOPBlocks.SMOOTH_BLACK_SANDSTONE.get()), () -> BOPBlocks.SMOOTH_BLACK_SANDSTONE.get(), STONE_VARIANTS_WITHOUT_SLAB_STAIRS);
    public static final BlockManager BOP_SMOOTH_ORANGE_SANDSTONE = CaliberBlockManager.registerBOP("smooth_orange_sandstone", () -> BlockBehaviour.Properties.copy(BOPBlocks.SMOOTH_ORANGE_SANDSTONE.get()), () -> BOPBlocks.SMOOTH_ORANGE_SANDSTONE.get(), STONE_VARIANTS_WITHOUT_SLAB_STAIRS);
    public static final BlockManager BOP_SMOOTH_WHITE_SANDSTONE = CaliberBlockManager.registerBOP("smooth_white_sandstone", () -> BlockBehaviour.Properties.copy(BOPBlocks.SMOOTH_WHITE_SANDSTONE.get()), () -> BOPBlocks.SMOOTH_WHITE_SANDSTONE.get(), STONE_VARIANTS_WITHOUT_SLAB_STAIRS);

    /* Planks */
    public static final BlockManager BOP_DEAD = CaliberBlockManager.registerBOP("dead_planks", () -> BlockBehaviour.Properties.copy(BOPBlocks.DEAD_PLANKS.get()), () -> BOPBlocks.DEAD_PLANKS.get(), PLANK_VARIANTS);
    public static final BlockManager BOP_FIR = CaliberBlockManager.registerBOP("fir_planks", () -> BlockBehaviour.Properties.copy(BOPBlocks.FIR_PLANKS.get()), () -> BOPBlocks.FIR_PLANKS.get(), PLANK_VARIANTS);
    public static final BlockManager BOP_HELLBARK = CaliberBlockManager.registerBOP("hellbark_planks", () -> BlockBehaviour.Properties.copy(BOPBlocks.HELLBARK_PLANKS.get()), () -> BOPBlocks.HELLBARK_PLANKS.get(), PLANK_VARIANTS);
    public static final BlockManager BOP_JACARANDA = CaliberBlockManager.registerBOP("jacaranda_planks", () -> BlockBehaviour.Properties.copy(BOPBlocks.JACARANDA_PLANKS.get()), () -> BOPBlocks.JACARANDA_PLANKS.get(), PLANK_VARIANTS);
    public static final BlockManager BOP_MAGIC = CaliberBlockManager.registerBOP("magic_planks", () -> BlockBehaviour.Properties.copy(BOPBlocks.MAGIC_PLANKS.get()), () -> BOPBlocks.MAGIC_PLANKS.get(), PLANK_VARIANTS);
    public static final BlockManager BOP_MAHOGANY = CaliberBlockManager.registerBOP("mahogany_planks", () -> BlockBehaviour.Properties.copy(BOPBlocks.MAHOGANY_PLANKS.get()), () -> BOPBlocks.MAHOGANY_PLANKS.get(), PLANK_VARIANTS);
//    public static final BlockManager BOP_MAPLE = CaliberBlockManager.registerBOP("maple_planks", () -> BlockBehaviour.Properties.copy(BOPBlocks.MAPLE_PLANKS.get()), () -> BOPBlocks.MAPLE_PLANKS.get(), PLANK_VARIANTS);
    public static final BlockManager BOP_PALM = CaliberBlockManager.registerBOP("palm_planks", () -> BlockBehaviour.Properties.copy(BOPBlocks.PALM_PLANKS.get()), () -> BOPBlocks.PALM_PLANKS.get(), PLANK_VARIANTS);
//    public static final BlockManager BOP_PINE = CaliberBlockManager.registerBOP("pine_planks", () -> BlockBehaviour.Properties.copy(BOPBlocks.PINE_PLANKS.get()), () -> BOPBlocks.PINE_PLANKS.get(), PLANK_VARIANTS);
    public static final BlockManager BOP_REDWOOD = CaliberBlockManager.registerBOP("redwood_planks", () -> BlockBehaviour.Properties.copy(BOPBlocks.REDWOOD_PLANKS.get()), () -> BOPBlocks.REDWOOD_PLANKS.get(), PLANK_VARIANTS);
    public static final BlockManager BOP_UMBRAN = CaliberBlockManager.registerBOP("umbran_planks", () -> BlockBehaviour.Properties.copy(BOPBlocks.UMBRAN_PLANKS.get()), () -> BOPBlocks.UMBRAN_PLANKS.get(), PLANK_VARIANTS);
    public static final BlockManager BOP_WILLOW = CaliberBlockManager.registerBOP("willow_planks", () -> BlockBehaviour.Properties.copy(BOPBlocks.WILLOW_PLANKS.get()), () -> BOPBlocks.WILLOW_PLANKS.get(), PLANK_VARIANTS);
