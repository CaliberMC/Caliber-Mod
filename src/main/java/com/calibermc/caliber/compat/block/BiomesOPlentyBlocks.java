...
public class BiomesOPlentyBlocks {
    ...
    public static final BlockManager BOP_CUT_BLACK_SANDSTONE = CaliberBlockManager.registerBOP("cut_black_sandstone", () -> BlockBehaviour.Properties.copy(BOPBlocks.CUT_BLACK_SANDSTONE.get()), () -> BOPBlocks.CUT_BLACK_SANDSTONE.get(), STONE_VARIANTS);
    public static final BlockManager BOP_CUT_ORANGE_SANDSTONE = CaliberBlockManager.registerBOP("cut_orange_sandstone", () -> BlockBehaviour.Properties.copy(BOPBlocks.CUT_ORANGE_SANDSTONE.get()), () -> BOPBlocks.CUT_ORANGE_SANDSTONE.get(), STONE_VARIANTS);
