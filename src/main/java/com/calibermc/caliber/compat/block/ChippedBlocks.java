...
public class ChippedBlocks {
    ...
    public static final DeferredRegister<Block> BLOCKS = DeferredRegister.create(ForgeRegistries.BLOCKS, "chipped");
...
//        registerManagersFor("waxed_exposed_copper_block", () -> BlockBehaviour.Properties.copy(Blocks.WAXED_EXPOSED_COPPER), ModBlocks.WAXED_EXPOSED_COPPER, Palettes.COPPER_BLOCK, STONE_VARIANTS);
//        registerManagersFor("waxed_oxidized_copper_block", () -> BlockBehaviour.Properties.copy(Blocks.WAXED_OXIDIZED_COPPER), ModBlocks.WAXED_OXIDIZED_COPPER, Palettes.COPPER_BLOCK, STONE_VARIANTS);
//        registerManagersFor("waxed_weathered_copper_block", () -> BlockBehaviour.Properties.copy(Blocks.WAXED_WEATHERED_COPPER), ModBlocks.WAXED_WEATHERED_COPPER, Palettes.COPPER_BLOCK, STONE_VARIANTS);
...
//        registerManagersFor("mud", () -> BlockBehaviour.Properties.copy(Blocks.DIRT), ModBlocks.MUD, Palettes.MUD, STONE_VARIANTS);
...
//    public static final Supplier<ModBlockHelper.ChangeBlockTexture> CHIPPED_TEXTURES = () -> new ModBlockHelper.ChangeBlockTexture() {
//        @SuppressWarnings("unchecked")
//        @Override
//        public <T extends Block> void fixBlockTex(ResourceLocation tex, Supplier<Block> textureFrom, Supplier<Block> b, Pair<BlockManager, ModBlockStateProvider> provider, ModBlockHelper.BlockGenLayerWithSides<T> genWithSides, ModBlockHelper.BlockGenWithBaseBlock<T> gen) {
...
//        CHIPPED_MANAGERS.add(CaliberBlockManager.registerChipped("%s".formatted(name), properties, () -> type.getBase(), variants)); // Base block
    ...
    private static <T extends Block> void registerBlockItem(String name, RegistryObject<T> block) {
        ChippedItems.ITEMS.register(name, () -> new BlockItem(block.get(), new Item.Properties()));
    }
