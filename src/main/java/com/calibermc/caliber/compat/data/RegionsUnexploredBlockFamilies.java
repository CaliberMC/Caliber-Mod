...
public class RegionsUnexploredBlockFamilies {
    ...
    /* Stone */
    public static final ModBlockFamily RU_ARGILLITE = familyBuilder(RuBlocks.ARGILLITE.get())
    ...
    public static final ModBlockFamily RU_CHALK_BRICKS = familyBuilder(RuBlocks.CHALK_BRICKS.get())
    ...
    public static final ModBlockFamily RU_POLISHED_CHALK = familyBuilder(RuBlocks.POLISHED_CHALK.get())
    ...
    /* Planks */
    public static final ModBlockFamily RU_BAOBAB_PLANKS = familyBuilder(RuBlocks.BAOBAB_PLANKS.get())
    ...
    public static final ModBlockFamily RU_BLACKWOOD_PLANKS = familyBuilder(RuBlocks.BLACKWOOD_PLANKS.get())
    ...
    public static final ModBlockFamily RU_BLUE_BIOSHROOM_PLANKS = familyBuilder(RuBlocks.BLUE_BIOSHROOM.get())
    ...
    public static final ModBlockFamily RU_BRIMWOOD_PLANKS = familyBuilder(RuBlocks.BRIMWOOD_PLANKS.get())
    ...
    public static final ModBlockFamily RU_COBALT_PLANKS = familyBuilder(RuBlocks.COBALT_PLANKS.get())
    ...
    public static final ModBlockFamily RU_CYPRESS_PLANKS = familyBuilder(RuBlocks.CYPRESS_PLANKS.get())
    ...
    public static final ModBlockFamily RU_DEAD_PLANKS = familyBuilder(RuBlocks.DEAD_PLANKS.get())
    ...
    public static final ModBlockFamily RU_EUCALYPTUS_PLANKS = familyBuilder(RuBlocks.EUCALYPTUS_PLANKS.get())
    ...
    public static final ModBlockFamily RU_GREEN_BIOSHROOM_PLANKS = familyBuilder(RuBlocks.GREEN_BIOSHROOM.get())
    ...
    public static final ModBlockFamily RU_JOSHUA_PLANKS = familyBuilder(RuBlocks.JOSHUA_PLANKS.get())
    ...
    public static final ModBlockFamily RU_KAPOK_PLANKS = familyBuilder(RuBlocks.KAPOK_PLANKS.get())
    ...
    public static final ModBlockFamily RU_LARCH_PLANKS = familyBuilder(RuBlocks.LARCH_PLANKS.get())
    ...
    public static final ModBlockFamily RU_MAGNOLIA_PLANKS = familyBuilder(RuBlocks.MAGNOLIA_PLANKS.get())
    ...
    public static final ModBlockFamily RU_MAPLE_PLANKS = familyBuilder(RuBlocks.MAPLE_PLANKS.get())
    ...
    public static final ModBlockFamily RU_MAUVE_PLANKS = familyBuilder(RuBlocks.MAUVE_PLANKS.get())
    ...
    public static final ModBlockFamily RU_PALM_PLANKS = familyBuilder(RuBlocks.PALM_PLANKS.get())
    ...
    public static final ModBlockFamily RU_PINE_PLANKS = familyBuilder(RuBlocks.PINE_PLANKS.get())
    ...
    public static final ModBlockFamily RU_PINK_BIOSHROOM_PLANKS = familyBuilder(RuBlocks.PINK_BIOSHROOM.get())
    ...
    public static final ModBlockFamily RU_REDWOOD_PLANKS = familyBuilder(RuBlocks.REDWOOD_PLANKS.get())
    ...
    public static final ModBlockFamily RU_SOCOTRA_PLANKS = familyBuilder(RuBlocks.SOCOTRA_PLANKS.get())
    ...
    public static final ModBlockFamily RU_WILLOW_PLANKS = familyBuilder(RuBlocks.WILLOW_PLANKS.get())
    ...
    /* Stripped Wood */
    public static final ModBlockFamily RU_STRIPPED_BAOBAB = familyBuilder(RuBlocks.STRIPPED_BAOBAB_WOOD.get())
            .fromManager(RegionsUnexploredBlocks.RU_STRIPPED_BAOBAB)
            .getFamily();

    public static final ModBlockFamily RU_STRIPPED_BLACKWOOD = familyBuilder(RuBlocks.STRIPPED_BLACKWOOD_WOOD.get())
            .fromManager(RegionsUnexploredBlocks.RU_STRIPPED_BLACKWOOD)
            .getFamily();

    public static final ModBlockFamily RU_STRIPPED_BLUE_BIOSHROOM = familyBuilder(RuBlocks.STRIPPED_BLUE_BIOSHROOM_HYPHAE.get())
            .fromManager(RegionsUnexploredBlocks.RU_STRIPPED_BLUE_BIOSHROOM)
            .getFamily();

    public static final ModBlockFamily RU_STRIPPED_BRIMWOOD = familyBuilder(RuBlocks.STRIPPED_BRIMWOOD_WOOD.get())
            .fromManager(RegionsUnexploredBlocks.RU_STRIPPED_BRIMWOOD)
            .getFamily();

    public static final ModBlockFamily RU_STRIPPED_COBALT = familyBuilder(RuBlocks.STRIPPED_COBALT_WOOD.get())
            .fromManager(RegionsUnexploredBlocks.RU_STRIPPED_COBALT)
            .getFamily();

    public static final ModBlockFamily RU_STRIPPED_CYPRESS = familyBuilder(RuBlocks.STRIPPED_CYPRESS_WOOD.get())
            .fromManager(RegionsUnexploredBlocks.RU_STRIPPED_CYPRESS)
            .getFamily();

    public static final ModBlockFamily RU_STRIPPED_DEAD = familyBuilder(RuBlocks.STRIPPED_DEAD_WOOD.get())
            .fromManager(RegionsUnexploredBlocks.RU_STRIPPED_DEAD)
            .getFamily();

    public static final ModBlockFamily RU_STRIPPED_EUCALYPTUS = familyBuilder(RuBlocks.STRIPPED_EUCALYPTUS_WOOD.get())
            .fromManager(RegionsUnexploredBlocks.RU_STRIPPED_EUCALYPTUS)
            .getFamily();

    public static final ModBlockFamily RU_STRIPPED_GREEN_BIOSHROOM = familyBuilder(RuBlocks.STRIPPED_GREEN_BIOSHROOM_HYPHAE.get())
            .fromManager(RegionsUnexploredBlocks.RU_STRIPPED_GREEN_BIOSHROOM)
            .getFamily();

    public static final ModBlockFamily RU_STRIPPED_JOSHUA = familyBuilder(RuBlocks.STRIPPED_JOSHUA_WOOD.get())
            .fromManager(RegionsUnexploredBlocks.RU_STRIPPED_JOSHUA)
            .getFamily();

    public static final ModBlockFamily RU_STRIPPED_KAPOK = familyBuilder(RuBlocks.STRIPPED_KAPOK_WOOD.get())
            .fromManager(RegionsUnexploredBlocks.RU_STRIPPED_KAPOK)
            .getFamily();

    public static final ModBlockFamily RU_STRIPPED_LARCH = familyBuilder(RuBlocks.STRIPPED_LARCH_WOOD.get())
            .fromManager(RegionsUnexploredBlocks.RU_STRIPPED_LARCH)
            .getFamily();

    public static final ModBlockFamily RU_STRIPPED_MAGNOLIA = familyBuilder(RuBlocks.STRIPPED_MAGNOLIA_WOOD.get())
            .fromManager(RegionsUnexploredBlocks.RU_STRIPPED_MAGNOLIA)
            .getFamily();

    public static final ModBlockFamily RU_STRIPPED_MAPLE = familyBuilder(RuBlocks.STRIPPED_MAPLE_WOOD.get())
            .fromManager(RegionsUnexploredBlocks.RU_STRIPPED_MAPLE)
            .getFamily();

    public static final ModBlockFamily RU_STRIPPED_MAUVE = familyBuilder(RuBlocks.STRIPPED_MAUVE_WOOD.get())
            .fromManager(RegionsUnexploredBlocks.RU_STRIPPED_MAUVE)
            .getFamily();

    public static final ModBlockFamily RU_STRIPPED_PALM = familyBuilder(RuBlocks.STRIPPED_PALM_WOOD.get())
            .fromManager(RegionsUnexploredBlocks.RU_STRIPPED_PALM)
            .getFamily();

    public static final ModBlockFamily RU_STRIPPED_PINE = familyBuilder(RuBlocks.STRIPPED_PINE_WOOD.get())
            .fromManager(RegionsUnexploredBlocks.RU_STRIPPED_PINE)
            .getFamily();

    public static final ModBlockFamily RU_STRIPPED_PINK_BIOSHROOM = familyBuilder(RuBlocks.STRIPPED_PINK_BIOSHROOM_HYPHAE.get())
            .fromManager(RegionsUnexploredBlocks.RU_STRIPPED_PINK_BIOSHROOM)
            .getFamily();

    public static final ModBlockFamily RU_STRIPPED_REDWOOD = familyBuilder(RuBlocks.STRIPPED_REDWOOD_WOOD.get())
            .fromManager(RegionsUnexploredBlocks.RU_STRIPPED_REDWOOD)
            .getFamily();

    public static final ModBlockFamily RU_STRIPPED_SOCOTRA = familyBuilder(RuBlocks.STRIPPED_SOCOTRA_WOOD.get())
            .fromManager(RegionsUnexploredBlocks.RU_STRIPPED_SOCOTRA)
            .getFamily();

    public static final ModBlockFamily RU_STRIPPED_WILLOW = familyBuilder(RuBlocks.STRIPPED_WILLOW_WOOD.get())
            .fromManager(RegionsUnexploredBlocks.RU_STRIPPED_WILLOW)
            .getFamily();

    public static final ModBlockFamily RU_STRIPPED_YELLOW_BIOSHROOM = familyBuilder(RuBlocks.STRIPPED_YELLOW_BIOSHROOM_HYPHAE.get())
            .fromManager(RegionsUnexploredBlocks.RU_STRIPPED_YELLOW_BIOSHROOM)
            .getFamily();

    /* Painted Planks */
    public static final ModBlockFamily RU_BLACK_PAINTED_PLANKS = familyBuilder(RuBlocks.BLACK_PAINTED_PLANKS.get())
    ...
    public static final ModBlockFamily RU_BLUE_PAINTED_PLANKS = familyBuilder(RuBlocks.BLUE_PAINTED_PLANKS.get())
    ...
    public static final ModBlockFamily RU_BROWN_PAINTED_PLANKS = familyBuilder(RuBlocks.BROWN_PAINTED_PLANKS.get())
    ...
    public static final ModBlockFamily RU_CYAN_PAINTED_PLANKS = familyBuilder(RuBlocks.CYAN_PAINTED_PLANKS.get())
    ...
    public static final ModBlockFamily RU_GRAY_PAINTED_PLANKS = familyBuilder(RuBlocks.GRAY_PAINTED_PLANKS.get())
    ...
    public static final ModBlockFamily RU_GREEN_PAINTED_PLANKS = familyBuilder(RuBlocks.GREEN_PAINTED_PLANKS.get())
    ...
    public static final ModBlockFamily RU_LIGHT_BLUE_PAINTED_PLANKS = familyBuilder(RuBlocks.LIGHT_BLUE_PAINTED_PLANKS.get())
    ...
    public static final ModBlockFamily RU_LIGHT_GRAY_PAINTED_PLANKS = familyBuilder(RuBlocks.LIGHT_GRAY_PAINTED_PLANKS.get())
    ...
    public static final ModBlockFamily RU_LIME_PAINTED_PLANKS = familyBuilder(RuBlocks.LIME_PAINTED_PLANKS.get())
    ...
    public static final ModBlockFamily RU_MAGENTA_PAINTED_PLANKS = familyBuilder(RuBlocks.MAGENTA_PAINTED_PLANKS.get())
    ...
    public static final ModBlockFamily RU_ORANGE_PAINTED_PLANKS = familyBuilder(RuBlocks.ORANGE_PAINTED_PLANKS.get())
    ...
    public static final ModBlockFamily RU_PINK_PAINTED_PLANKS = familyBuilder(RuBlocks.PINK_PAINTED_PLANKS.get())
    ...
    public static final ModBlockFamily RU_PURPLE_PAINTED_PLANKS = familyBuilder(RuBlocks.PURPLE_PAINTED_PLANKS.get())
    ...
    public static final ModBlockFamily RU_RED_PAINTED_PLANKS = familyBuilder(RuBlocks.RED_PAINTED_PLANKS.get())
    ...
    public static final ModBlockFamily RU_WHITE_PAINTED_PLANKS = familyBuilder(RuBlocks.WHITE_PAINTED_PLANKS.get())
    ...
    public static final ModBlockFamily RU_YELLOW_PAINTED_PLANKS = familyBuilder(RuBlocks.YELLOW_PAINTED_PLANKS.get())
