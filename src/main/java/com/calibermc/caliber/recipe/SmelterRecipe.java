...
public class SmelterRecipe implements Recipe<SimpleContainer> {
    ...
    public static class Serializer implements RecipeSerializer<SmelterRecipe> {
        ...
        public static final ResourceLocation ID =
                new ResourceLocation(Caliber.MOD_ID,"alloying");
        ...
        @Override
        public SmelterRecipe fromNetwork(ResourceLocation id, FriendlyByteBuf buf) {
        ...
        @Override
        public void toNetwork(FriendlyByteBuf buf, SmelterRecipe recipe) {
