...
import com.calibermc.caliber.block.entity.SmelterBlockEntity;
import com.calibermc.caliber.screen.slot.ModResultSlot;
...
public class SmelterMenu extends AbstractContainerMenu {
    ...
    public SmelterMenu(int pContainerId, Inventory inv, BlockEntity entity, ContainerData data) {
        super(ModMenuTypes.SMELTER_MENU.get(), pContainerId);
...
//            this.addSlot(new ModResultSlot(handler, 3, 80, 60));
            ...
            this.addSlot(new SlotItemHandler(handler, 0, 57, 40));
            this.addSlot(new SlotItemHandler(handler, 1, 57, 18));
            this.addSlot(new SlotItemHandler(handler, 2, 103, 40));
