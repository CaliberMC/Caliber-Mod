...
//            () -> new DiagonalCornerBlock(BlockBehaviour.Properties.of(Material.STONE).strength(1.5f).requiresCorrectToolForDrops()), CreativeTabs.CALIBER_TAB);
...
//            () -> new DiagonalCornerBlock(BlockBehaviour.Properties.of(Material.STONE).strength(2.0f).requiresCorrectToolForDrops()), CreativeTabs.CALIBER_TAB);
