...
//            () -> new TappedBirchLog(BlockBehaviour.Properties.of(Material.WOOD).strength(2.0F).sound(SoundType.WOOD)));
    ...
    /* Bricks */
    public static final BlockManager BRICK = BlockManager.register("brick", BlockProps.BRICK.get(), () -> Blocks.BRICKS, VARIANTS_WITHOUT_STAIRS_WALL);

    /* Calcite */
    public static final BlockManager CALCITE = BlockManager.register("calcite", BlockProps.CALCITE.get(), () -> Blocks.CALCITE, VARIANTS);
    ...
    /* Dripstone */
    public static final BlockManager DRIPSTONE = BlockManager.register("dripstone", BlockProps.DRIPSTONE_BLOCK.get(), () -> Blocks.DRIPSTONE_BLOCK, VARIANTS);

    /* End Stone */
    public static final BlockManager END_STONE = BlockManager.register("end_stone", BlockProps.END_STONE.get(), () -> Blocks.END_STONE, VARIANTS);
    public static final BlockManager END_STONE_BRICK = BlockManager.register("end_stone_brick", BlockProps.END_STONE_BRICK.get(), () -> Blocks.END_STONE_BRICKS, VARIANTS_WITHOUT_STAIRS_WALL);

    /* Granite */
    public static final BlockManager BLACK_GRANITE = BlockManager.register("black_granite", BlockProps.GRANITE.get(), CaliberBlockHelper.modifyList(VARIANTS, (c) -> c.add(ModBlockFamily.Variant.BASE)));
    public static final BlockManager BROWN_GRANITE = BlockManager.register("brown_granite", BlockProps.GRANITE.get(), CaliberBlockHelper.modifyList(VARIANTS, (c) -> c.add(ModBlockFamily.Variant.BASE)));
    public static final BlockManager GRAY_GRANITE = BlockManager.register("gray_granite", BlockProps.GRANITE.get(), CaliberBlockHelper.modifyList(VARIANTS, (c) -> c.add(ModBlockFamily.Variant.BASE)));
    public static final BlockManager PINK_GRANITE = BlockManager.register("pink_granite", BlockProps.GRANITE.get(), CaliberBlockHelper.modifyList(VARIANTS, (c) -> c.add(ModBlockFamily.Variant.BASE)));
    public static final BlockManager WHITE_GRANITE = BlockManager.register("white_granite", BlockProps.GRANITE.get(), CaliberBlockHelper.modifyList(VARIANTS, (c) -> c.add(ModBlockFamily.Variant.BASE)));
    public static final BlockManager RED_GRANITE = BlockManager.register("red_granite", BlockProps.GRANITE.get(), () -> Blocks.GRANITE, VARIANTS.stream().filter(v -> v != STAIRS && v != WALL).toList());

    /* Polished Granite */
    public static final BlockManager POLISHED_BLACK_GRANITE = BlockManager.register("polished_black_granite", BlockProps.GRANITE.get(), CaliberBlockHelper.modifyList(VARIANTS, (c) -> c.add(ModBlockFamily.Variant.BASE)));
    public static final BlockManager POLISHED_BROWN_GRANITE = BlockManager.register("polished_brown_granite", BlockProps.GRANITE.get(), CaliberBlockHelper.modifyList(VARIANTS, (c) -> c.add(ModBlockFamily.Variant.BASE)));
    public static final BlockManager POLISHED_GRAY_GRANITE = BlockManager.register("polished_gray_granite", BlockProps.GRANITE.get(), CaliberBlockHelper.modifyList(VARIANTS, (c) -> c.add(ModBlockFamily.Variant.BASE)));
    public static final BlockManager POLISHED_PINK_GRANITE = BlockManager.register("polished_pink_granite", BlockProps.GRANITE.get(), CaliberBlockHelper.modifyList(VARIANTS, (c) -> c.add(ModBlockFamily.Variant.BASE)));
    public static final BlockManager POLISHED_WHITE_GRANITE = BlockManager.register("polished_white_granite", BlockProps.GRANITE.get(), CaliberBlockHelper.modifyList(VARIANTS, (c) -> c.add(ModBlockFamily.Variant.BASE)));
    public static final BlockManager POLISHED_RED_GRANITE = BlockManager.register("polished_red_granite", BlockProps.GRANITE.get(), () -> Blocks.POLISHED_GRANITE, VARIANTS.stream().filter(v -> v != STAIRS).toList());
    ...
    public static final BlockManager LIMESTONE = BlockManager.register("limestone", BlockProps.LIMESTONE.get(), () -> Blocks.STONE, VARIANTS.stream().filter(v -> v != STAIRS).toList());

    /* Cobbled Limestone */
    public static final BlockManager COBBLED_DARK_LIMESTONE = BlockManager.register("cobbled_dark_limestone", BlockProps.COBBLESTONE.get(), CaliberBlockHelper.modifyList(VARIANTS, (c) -> c.add(ModBlockFamily.Variant.BASE)));
    public static final BlockManager COBBLED_LIGHT_LIMESTONE = BlockManager.register("cobbled_light_limestone", BlockProps.COBBLESTONE.get(), CaliberBlockHelper.modifyList(VARIANTS, (c) -> c.add(ModBlockFamily.Variant.BASE)));
    public static final BlockManager COBBLED_PINK_LIMESTONE = BlockManager.register("cobbled_pink_limestone", BlockProps.COBBLESTONE.get(), CaliberBlockHelper.modifyList(VARIANTS, (c) -> c.add(ModBlockFamily.Variant.BASE)));
    public static final BlockManager COBBLED_TAN_LIMESTONE = BlockManager.register("cobbled_tan_limestone", BlockProps.COBBLESTONE.get(), CaliberBlockHelper.modifyList(VARIANTS, (c) -> c.add(ModBlockFamily.Variant.BASE)));
    public static final BlockManager COBBLED_LIMESTONE = BlockManager.register("cobbled_limestone", BlockProps.COBBLESTONE.get(), () -> Blocks.COBBLESTONE, VARIANTS.stream().filter(v -> v != STAIRS && v != WALL).toList());

    /* Mossy Cobbled Limestone */
    public static final BlockManager MOSSY_COBBLED_DARK_LIMESTONE = BlockManager.register("mossy_cobbled_dark_limestone", BlockProps.COBBLESTONE.get(), CaliberBlockHelper.modifyList(VARIANTS, (c) -> c.add(ModBlockFamily.Variant.BASE)));
    public static final BlockManager MOSSY_COBBLED_LIGHT_LIMESTONE = BlockManager.register("mossy_cobbled_light_limestone", BlockProps.COBBLESTONE.get(), CaliberBlockHelper.modifyList(VARIANTS, (c) -> c.add(ModBlockFamily.Variant.BASE)));
    public static final BlockManager MOSSY_COBBLED_PINK_LIMESTONE = BlockManager.register("mossy_cobbled_pink_limestone", BlockProps.COBBLESTONE.get(), CaliberBlockHelper.modifyList(VARIANTS, (c) -> c.add(ModBlockFamily.Variant.BASE)));
    public static final BlockManager MOSSY_COBBLED_TAN_LIMESTONE = BlockManager.register("mossy_cobbled_tan_limestone", BlockProps.COBBLESTONE.get(), CaliberBlockHelper.modifyList(VARIANTS, (c) -> c.add(ModBlockFamily.Variant.BASE)));
    public static final BlockManager MOSSY_COBBLED_LIMESTONE = BlockManager.register("mossy_cobbled_limestone", BlockProps.COBBLESTONE.get(), () -> Blocks.MOSSY_COBBLESTONE, VARIANTS.stream().filter(v -> v != STAIRS && v != WALL).toList());

    /* Limestone Bricks */
    public static final BlockManager DARK_LIMESTONE_BRICK = BlockManager.register("dark_limestone_bricks", BlockProps.LIMESTONE_BRICK.get(), CaliberBlockHelper.modifyList(VARIANTS, (c) -> c.add(ModBlockFamily.Variant.BASE)));
    public static final BlockManager LIGHT_LIMESTONE_BRICK = BlockManager.register("light_limestone_bricks", BlockProps.LIMESTONE_BRICK.get(), CaliberBlockHelper.modifyList(VARIANTS, (c) -> c.add(ModBlockFamily.Variant.BASE)));
    public static final BlockManager PINK_LIMESTONE_BRICK = BlockManager.register("pink_limestone_bricks", BlockProps.LIMESTONE_BRICK.get(), CaliberBlockHelper.modifyList(VARIANTS, (c) -> c.add(ModBlockFamily.Variant.BASE)));
    public static final BlockManager TAN_LIMESTONE_BRICK = BlockManager.register("tan_limestone_bricks", BlockProps.LIMESTONE_BRICK.get(), CaliberBlockHelper.modifyList(VARIANTS, (c) -> c.add(ModBlockFamily.Variant.BASE)));
    public static final BlockManager LIMESTONE_BRICK = BlockManager.register("limestone_bricks", BlockProps.LIMESTONE_BRICK.get(), () -> Blocks.STONE_BRICKS, VARIANTS.stream().filter(v -> v != STAIRS && v != WALL).toList());

    /* Mossy Limestone Bricks */
    public static final BlockManager MOSSY_DARK_LIMESTONE_BRICK = BlockManager.register("mossy_dark_limestone_bricks", BlockProps.LIMESTONE_BRICK.get(), CaliberBlockHelper.modifyList(VARIANTS, (c) -> c.add(ModBlockFamily.Variant.BASE)));
    public static final BlockManager MOSSY_LIGHT_LIMESTONE_BRICK = BlockManager.register("mossy_light_limestone_bricks", BlockProps.LIMESTONE_BRICK.get(), CaliberBlockHelper.modifyList(VARIANTS, (c) -> c.add(ModBlockFamily.Variant.BASE)));
    public static final BlockManager MOSSY_PINK_LIMESTONE_BRICK = BlockManager.register("mossy_pink_limestone_bricks", BlockProps.LIMESTONE_BRICK.get(), CaliberBlockHelper.modifyList(VARIANTS, (c) -> c.add(ModBlockFamily.Variant.BASE)));
    public static final BlockManager MOSSY_TAN_LIMESTONE_BRICK = BlockManager.register("mossy_tan_limestone_bricks", BlockProps.LIMESTONE_BRICK.get(), CaliberBlockHelper.modifyList(VARIANTS, (c) -> c.add(ModBlockFamily.Variant.BASE)));
    public static final BlockManager MOSSY_LIMESTONE_BRICK = BlockManager.register("mossy_limestone_bricks", BlockProps.LIMESTONE_BRICK.get(), () -> Blocks.MOSSY_STONE_BRICKS, VARIANTS.stream().filter(v -> v != STAIRS && v != WALL).toList());
    ...
    /* Smooth Limestone */
    public static final BlockManager SMOOTH_DARK_LIMESTONE = BlockManager.register("smooth_dark_limestone", BlockProps.SMOOTH_LIMESTONE.get(), CaliberBlockHelper.modifyList(VARIANTS, (c) -> c.add(ModBlockFamily.Variant.BASE)));
    public static final BlockManager SMOOTH_LIGHT_LIMESTONE = BlockManager.register("smooth_light_limestone", BlockProps.SMOOTH_LIMESTONE.get(), CaliberBlockHelper.modifyList(VARIANTS, (c) -> c.add(ModBlockFamily.Variant.BASE)));
    public static final BlockManager SMOOTH_PINK_LIMESTONE = BlockManager.register("smooth_pink_limestone", BlockProps.SMOOTH_LIMESTONE.get(), CaliberBlockHelper.modifyList(VARIANTS, (c) -> c.add(ModBlockFamily.Variant.BASE)));
    public static final BlockManager SMOOTH_TAN_LIMESTONE = BlockManager.register("smooth_tan_limestone", BlockProps.SMOOTH_LIMESTONE.get(), CaliberBlockHelper.modifyList(VARIANTS, (c) -> c.add(ModBlockFamily.Variant.BASE)));
    public static final BlockManager SMOOTH_LIMESTONE = BlockManager.register("smooth_limestone", BlockProps.SMOOTH_LIMESTONE.get(), () -> Blocks.SMOOTH_STONE, VARIANTS);

    /* Marble */
    public static final BlockManager BLACK_MARBLE = BlockManager.register("black_marble", BlockProps.MARBLE.get(), CaliberBlockHelper.modifyList(VARIANTS, (c) -> c.add(ModBlockFamily.Variant.BASE)));
    public static final BlockManager GRAY_MARBLE = BlockManager.register("gray_marble", BlockProps.MARBLE.get(), CaliberBlockHelper.modifyList(VARIANTS, (c) -> c.add(ModBlockFamily.Variant.BASE)));
    public static final BlockManager PINK_MARBLE = BlockManager.register("pink_marble", BlockProps.MARBLE.get(), CaliberBlockHelper.modifyList(VARIANTS, (c) -> c.add(ModBlockFamily.Variant.BASE)));
    public static final BlockManager RED_MARBLE = BlockManager.register("red_marble", BlockProps.MARBLE.get(), CaliberBlockHelper.modifyList(VARIANTS, (c) -> c.add(ModBlockFamily.Variant.BASE)));
    public static final BlockManager WHITE_MARBLE = BlockManager.register("white_marble", BlockProps.MARBLE.get(), CaliberBlockHelper.modifyList(VARIANTS, (c) -> c.add(ModBlockFamily.Variant.BASE)));

    /* Polished Marble */
    public static final BlockManager POLISHED_BLACK_MARBLE = BlockManager.register("polished_black_marble", BlockProps.MARBLE.get(), CaliberBlockHelper.modifyList(VARIANTS, (c) -> c.add(ModBlockFamily.Variant.BASE)));
    public static final BlockManager POLISHED_GRAY_MARBLE = BlockManager.register("polished_gray_marble", BlockProps.MARBLE.get(), CaliberBlockHelper.modifyList(VARIANTS, (c) -> c.add(ModBlockFamily.Variant.BASE)));
    public static final BlockManager POLISHED_PINK_MARBLE = BlockManager.register("polished_pink_marble", BlockProps.MARBLE.get(), CaliberBlockHelper.modifyList(VARIANTS, (c) -> c.add(ModBlockFamily.Variant.BASE)));
    public static final BlockManager POLISHED_RED_MARBLE = BlockManager.register("polished_red_marble", BlockProps.MARBLE.get(), CaliberBlockHelper.modifyList(VARIANTS, (c) -> c.add(ModBlockFamily.Variant.BASE)));
    public static final BlockManager POLISHED_WHITE_MARBLE = BlockManager.register("polished_white_marble", BlockProps.MARBLE.get(), CaliberBlockHelper.modifyList(VARIANTS, (c) -> c.add(ModBlockFamily.Variant.BASE)));

    /* Netherite */
    public static final BlockManager NETHERITE = BlockManager.register("netherite_block", BlockProps.NETHERITE.get(), () -> Blocks.NETHERITE_BLOCK, VARIANTS);

    /* Nether Bricks */
    public static final BlockManager NETHER_BRICK = BlockManager.register("nether_brick", BlockProps.NETHER_BRICK.get(), () -> Blocks.NETHER_BRICKS, VARIANTS_WITHOUT_STAIRS_WALL);
    public static final BlockManager RED_NETHER_BRICK = BlockManager.register("red_nether_brick", BlockProps.NETHER_BRICK.get(), () -> Blocks.RED_NETHER_BRICKS, VARIANTS_WITHOUT_STAIRS_WALL);

    /* Obsidian */
    public static final BlockManager OBSIDIAN = BlockManager.register("obsidian", BlockProps.OBSIDIAN.get(), () -> Blocks.OBSIDIAN, VARIANTS);

    /* Prismarine */
    public static final BlockManager PRISMARINE = BlockManager.register("prismarine", BlockProps.PRISMARINE.get(), () -> Blocks.PRISMARINE, VARIANTS_WITHOUT_STAIRS_WALL);
    public static final BlockManager PRISMARINE_BRICK = BlockManager.register("prismarine_brick", BlockProps.PRISMARINE.get(), () -> Blocks.PRISMARINE_BRICKS, VARIANTS_WITHOUT_STAIRS);
    public static final BlockManager DARK_PRISMARINE = BlockManager.register("dark_prismarine", BlockProps.PRISMARINE.get(), () -> Blocks.DARK_PRISMARINE, VARIANTS_WITHOUT_STAIRS);

    /* Purpur */
    public static final BlockManager PURPUR = BlockManager.register("purpur", BlockProps.PURPUR.get(), () -> Blocks.PURPUR_BLOCK, VARIANTS_WITHOUT_STAIRS);
    ...
    public static final BlockManager QUARTZ_BRICKS = BlockManager.register("quartz_bricks", BlockProps.QUARTZ.get(), () -> Blocks.QUARTZ_BRICKS, VARIANTS);
    ...
    /* Sandstone */
    public static final BlockManager BROWN_SANDSTONE = BlockManager.register("brown_sandstone", BlockProps.SANDSTONE.get(), CaliberBlockHelper.modifyList(VARIANTS, (c) -> c.add(ModBlockFamily.Variant.BASE)));
    public static final BlockManager ORANGE_SANDSTONE = BlockManager.register("orange_sandstone", BlockProps.SANDSTONE.get(), CaliberBlockHelper.modifyList(VARIANTS, (c) -> c.add(ModBlockFamily.Variant.BASE)));
    ...
    /* Cut Sandstone */
    public static final BlockManager CUT_BROWN_SANDSTONE = BlockManager.register("cut_brown_sandstone", BlockProps.SANDSTONE.get(), CaliberBlockHelper.modifyList(VARIANTS, (c) -> c.add(ModBlockFamily.Variant.BASE)));
    public static final BlockManager CUT_ORANGE_SANDSTONE = BlockManager.register("cut_orange_sandstone", BlockProps.SANDSTONE.get(), CaliberBlockHelper.modifyList(VARIANTS, (c) -> c.add(ModBlockFamily.Variant.BASE)));
    public static final BlockManager CUT_RED_SANDSTONE = BlockManager.register("cut_red_sandstone", BlockProps.SANDSTONE.get(), () -> Blocks.CUT_RED_SANDSTONE, VARIANTS);
    public static final BlockManager CUT_SANDSTONE = BlockManager.register("cut_sandstone", BlockProps.SANDSTONE.get(), () -> Blocks.CUT_SANDSTONE, VARIANTS);

    /* Smooth Sandstone */
    public static final BlockManager SMOOTH_BROWN_SANDSTONE = BlockManager.register("smooth_brown_sandstone", BlockProps.SANDSTONE.get(), CaliberBlockHelper.modifyList(VARIANTS, (c) -> c.add(ModBlockFamily.Variant.BASE)));
    public static final BlockManager SMOOTH_ORANGE_SANDSTONE = BlockManager.register("smooth_orange_sandstone", BlockProps.SANDSTONE.get(), CaliberBlockHelper.modifyList(VARIANTS, (c) -> c.add(ModBlockFamily.Variant.BASE)));
    ...
    /* Tuff */
    public static final BlockManager TUFF = BlockManager.register("tuff", BlockProps.TUFF.get(), () -> Blocks.TUFF, VARIANTS);
...
//    public static final RegistryObject<Block> FARMLAND_LAYER = registerBlock("farmland_layer", () -> new TerrainLayerBlock(BlockProps.FARMLAND.get()));
    ...
    /* Planks */
    public static final BlockManager ACACIA = BlockManager.register("acacia", BlockProps.PLANK.get(), () -> Blocks.ACACIA_PLANKS, PLANK_VARIANTS);
    public static final BlockManager BIRCH = BlockManager.register("birch", BlockProps.PLANK.get(), () -> Blocks.BIRCH_PLANKS, PLANK_VARIANTS);
    public static final BlockManager DARK_OAK = BlockManager.register("dark_oak", BlockProps.PLANK.get(), () -> Blocks.DARK_OAK_PLANKS, PLANK_VARIANTS);
    public static final BlockManager JUNGLE = BlockManager.register("jungle", BlockProps.PLANK.get(), () -> Blocks.JUNGLE_PLANKS, PLANK_VARIANTS);
    public static final BlockManager OAK = BlockManager.register("oak", BlockProps.PLANK.get(), () -> Blocks.OAK_PLANKS, PLANK_VARIANTS);
    public static final BlockManager SPRUCE = BlockManager.register("spruce", BlockProps.PLANK.get(), () -> Blocks.SPRUCE_PLANKS, PLANK_VARIANTS);
    public static final BlockManager CRIMSON = BlockManager.register("crimson", BlockProps.PLANK.get(), () -> Blocks.CRIMSON_PLANKS, PLANK_VARIANTS);
    public static final BlockManager WARPED = BlockManager.register("warped", BlockProps.PLANK.get(), () -> Blocks.WARPED_PLANKS, PLANK_VARIANTS);
    ...
    /* Stained Planks */
    public static final BlockManager STAINED_ACACIA = BlockManager.register("stained_acacia_planks", BlockProps.PLANK.get(), CaliberBlockHelper.modifyList(MOD_PLANK_VARIANTS, (c) -> c.add(ModBlockFamily.Variant.BASE)));
    ...
    public static final BlockManager STAINED_BIRCH = BlockManager.register("stained_birch_planks", BlockProps.PLANK.get(), CaliberBlockHelper.modifyList(MOD_PLANK_VARIANTS, (c) -> c.add(ModBlockFamily.Variant.BASE)));
    ...
    public static final BlockManager STAINED_DARK_OAK = BlockManager.register("stained_dark_oak_planks", BlockProps.PLANK.get(), CaliberBlockHelper.modifyList(MOD_PLANK_VARIANTS, (c) -> c.add(ModBlockFamily.Variant.BASE)));
    ...
    public static final BlockManager STAINED_JUNGLE = BlockManager.register("stained_jungle_planks", BlockProps.PLANK.get(), CaliberBlockHelper.modifyList(MOD_PLANK_VARIANTS, (c) -> c.add(ModBlockFamily.Variant.BASE)));
    ...
    public static final BlockManager STAINED_OAK = BlockManager.register("stained_oak_planks", BlockProps.PLANK.get(), CaliberBlockHelper.modifyList(MOD_PLANK_VARIANTS, (c) -> c.add(ModBlockFamily.Variant.BASE)));
    ...
    public static final BlockManager STAINED_SPRUCE = BlockManager.register("stained_spruce_planks", BlockProps.PLANK.get(), CaliberBlockHelper.modifyList(MOD_PLANK_VARIANTS, (c) -> c.add(ModBlockFamily.Variant.BASE)));
    ...
    public static final BlockManager MOSSY_STAINED_ACACIA = BlockManager.register("mossy_stained_acacia_planks", BlockProps.PLANK.get(), CaliberBlockHelper.modifyList(MOD_PLANK_VARIANTS, (c) -> c.add(ModBlockFamily.Variant.BASE)));
    public static final BlockManager MOSSY_STAINED_BIRCH = BlockManager.register("mossy_stained_birch_planks", BlockProps.PLANK.get(), CaliberBlockHelper.modifyList(MOD_PLANK_VARIANTS, (c) -> c.add(ModBlockFamily.Variant.BASE)));
    public static final BlockManager MOSSY_STAINED_DARK_OAK = BlockManager.register("mossy_stained_dark_oak_planks", BlockProps.PLANK.get(), CaliberBlockHelper.modifyList(MOD_PLANK_VARIANTS, (c) -> c.add(ModBlockFamily.Variant.BASE)));
    public static final BlockManager MOSSY_STAINED_JUNGLE = BlockManager.register("mossy_stained_jungle_planks", BlockProps.PLANK.get(), CaliberBlockHelper.modifyList(MOD_PLANK_VARIANTS, (c) -> c.add(ModBlockFamily.Variant.BASE)));
    public static final BlockManager MOSSY_STAINED_OAK = BlockManager.register("mossy_stained_oak_planks", BlockProps.PLANK.get(), CaliberBlockHelper.modifyList(MOD_PLANK_VARIANTS, (c) -> c.add(ModBlockFamily.Variant.BASE)));
    public static final BlockManager MOSSY_STAINED_SPRUCE = BlockManager.register("mossy_stained_spruce_planks", BlockProps.PLANK.get(), CaliberBlockHelper.modifyList(MOD_PLANK_VARIANTS, (c) -> c.add(ModBlockFamily.Variant.BASE)));

    /* Stripped Wood */
    public static final BlockManager STRIPPED_ACACIA = BlockManager.register("stripped_acacia", BlockProps.PLANK.get(), () -> Blocks.STRIPPED_ACACIA_WOOD, FINISHED_WOOD_VARIANTS);
    public static final BlockManager STRIPPED_BIRCH = BlockManager.register("stripped_birch", BlockProps.PLANK.get(), () -> Blocks.STRIPPED_BIRCH_WOOD, FINISHED_WOOD_VARIANTS);
    public static final BlockManager STRIPPED_DARK_OAK = BlockManager.register("stripped_dark_oak", BlockProps.PLANK.get(), () -> Blocks.STRIPPED_DARK_OAK_WOOD, FINISHED_WOOD_VARIANTS);
    public static final BlockManager STRIPPED_JUNGLE = BlockManager.register("stripped_jungle", BlockProps.PLANK.get(), () -> Blocks.STRIPPED_JUNGLE_WOOD, FINISHED_WOOD_VARIANTS);
    public static final BlockManager STRIPPED_OAK = BlockManager.register("stripped_oak", BlockProps.PLANK.get(), () -> Blocks.STRIPPED_OAK_WOOD, FINISHED_WOOD_VARIANTS);
    public static final BlockManager STRIPPED_SPRUCE = BlockManager.register("stripped_spruce", BlockProps.PLANK.get(), () -> Blocks.STRIPPED_SPRUCE_WOOD, FINISHED_WOOD_VARIANTS);
    public static final BlockManager STRIPPED_CRIMSON = BlockManager.register("stripped_crimson", BlockProps.PLANK.get(), () -> Blocks.STRIPPED_CRIMSON_HYPHAE, FINISHED_WOOD_VARIANTS);
    public static final BlockManager STRIPPED_WARPED = BlockManager.register("stripped_warped", BlockProps.PLANK.get(), () -> Blocks.STRIPPED_WARPED_HYPHAE, FINISHED_WOOD_VARIANTS);

    /* Stained Stripped Wood */
    public static final BlockManager STAINED_STRIPPED_ACACIA = BlockManager.register("stained_stripped_acacia_wood", BlockProps.PLANK.get(), CaliberBlockHelper.modifyList(FINISHED_WOOD_VARIANTS, (c) -> c.add(ModBlockFamily.Variant.BASE)));
    public static final BlockManager STAINED_STRIPPED_BIRCH = BlockManager.register("stained_stripped_birch_wood", BlockProps.PLANK.get(), CaliberBlockHelper.modifyList(FINISHED_WOOD_VARIANTS, (c) -> c.add(ModBlockFamily.Variant.BASE)));
    public static final BlockManager STAINED_STRIPPED_DARK_OAK = BlockManager.register("stained_stripped_dark_oak_wood", BlockProps.PLANK.get(), CaliberBlockHelper.modifyList(FINISHED_WOOD_VARIANTS, (c) -> c.add(ModBlockFamily.Variant.BASE)));
    public static final BlockManager STAINED_STRIPPED_JUNGLE = BlockManager.register("stained_stripped_jungle_wood", BlockProps.PLANK.get(), CaliberBlockHelper.modifyList(FINISHED_WOOD_VARIANTS, (c) -> c.add(ModBlockFamily.Variant.BASE)));
    public static final BlockManager STAINED_STRIPPED_OAK = BlockManager.register("stained_stripped_oak_wood", BlockProps.PLANK.get(), CaliberBlockHelper.modifyList(FINISHED_WOOD_VARIANTS, (c) -> c.add(ModBlockFamily.Variant.BASE)));
    public static final BlockManager STAINED_STRIPPED_SPRUCE = BlockManager.register("stained_stripped_spruce_wood", BlockProps.PLANK.get(), CaliberBlockHelper.modifyList(FINISHED_WOOD_VARIANTS, (c) -> c.add(ModBlockFamily.Variant.BASE)));

    /* Boards & Shingles */
    public static final BlockManager ACACIA_BOARDS = BlockManager.register("acacia_boards", BlockProps.PLANK.get(), CaliberBlockHelper.modifyList(PLANK_VARIANTS, (c) -> c.add(ModBlockFamily.Variant.BASE)));
    public static final BlockManager BIRCH_BOARDS = BlockManager.register("birch_boards", BlockProps.PLANK.get(), CaliberBlockHelper.modifyList(PLANK_VARIANTS, (c) -> c.add(ModBlockFamily.Variant.BASE)));
    public static final BlockManager DARK_OAK_BOARDS = BlockManager.register("dark_oak_boards", BlockProps.PLANK.get(), CaliberBlockHelper.modifyList(PLANK_VARIANTS, (c) -> c.add(ModBlockFamily.Variant.BASE)));
    public static final BlockManager JUNGLE_BOARDS = BlockManager.register("jungle_boards", BlockProps.PLANK.get(), CaliberBlockHelper.modifyList(PLANK_VARIANTS, (c) -> c.add(ModBlockFamily.Variant.BASE)));
    public static final BlockManager OAK_BOARDS = BlockManager.register("oak_boards", BlockProps.PLANK.get(), CaliberBlockHelper.modifyList(PLANK_VARIANTS, (c) -> c.add(ModBlockFamily.Variant.BASE)));
    public static final BlockManager SPRUCE_BOARDS = BlockManager.register("spruce_boards", BlockProps.PLANK.get(), CaliberBlockHelper.modifyList(PLANK_VARIANTS, (c) -> c.add(ModBlockFamily.Variant.BASE)));
    public static final BlockManager CRIMSON_BOARDS = BlockManager.register("crimson_boards", BlockProps.PLANK.get(), CaliberBlockHelper.modifyList(PLANK_VARIANTS, (c) -> c.add(ModBlockFamily.Variant.BASE)));
    public static final BlockManager WARPED_BOARDS = BlockManager.register("warped_boards", BlockProps.PLANK.get(), CaliberBlockHelper.modifyList(PLANK_VARIANTS, (c) -> c.add(ModBlockFamily.Variant.BASE)));
    ...
    public static final BlockManager MOSSY_ACACIA_BOARDS = BlockManager.register("mossy_acacia_boards", BlockProps.PLANK.get(), CaliberBlockHelper.modifyList(PLANK_VARIANTS, (c) -> c.add(ModBlockFamily.Variant.BASE)));
    public static final BlockManager MOSSY_BIRCH_BOARDS = BlockManager.register("mossy_birch_boards", BlockProps.PLANK.get(), CaliberBlockHelper.modifyList(PLANK_VARIANTS, (c) -> c.add(ModBlockFamily.Variant.BASE)));
    public static final BlockManager MOSSY_DARK_OAK_BOARDS = BlockManager.register("mossy_dark_oak_boards", BlockProps.PLANK.get(), CaliberBlockHelper.modifyList(PLANK_VARIANTS, (c) -> c.add(ModBlockFamily.Variant.BASE)));
    public static final BlockManager MOSSY_JUNGLE_BOARDS = BlockManager.register("mossy_jungle_boards", BlockProps.PLANK.get(), CaliberBlockHelper.modifyList(PLANK_VARIANTS, (c) -> c.add(ModBlockFamily.Variant.BASE)));
    public static final BlockManager MOSSY_OAK_BOARDS = BlockManager.register("mossy_oak_boards", BlockProps.PLANK.get(), CaliberBlockHelper.modifyList(PLANK_VARIANTS, (c) -> c.add(ModBlockFamily.Variant.BASE)));
    public static final BlockManager MOSSY_SPRUCE_BOARDS = BlockManager.register("mossy_spruce_boards", BlockProps.PLANK.get(), CaliberBlockHelper.modifyList(PLANK_VARIANTS, (c) -> c.add(ModBlockFamily.Variant.BASE)));
    public static final BlockManager MOSSY_CRIMSON_BOARDS = BlockManager.register("mossy_crimson_boards", BlockProps.PLANK.get(), CaliberBlockHelper.modifyList(PLANK_VARIANTS, (c) -> c.add(ModBlockFamily.Variant.BASE)));
    public static final BlockManager MOSSY_WARPED_BOARDS = BlockManager.register("mossy_warped_boards", BlockProps.PLANK.get(), CaliberBlockHelper.modifyList(PLANK_VARIANTS, (c) -> c.add(ModBlockFamily.Variant.BASE)));
    ...
    public static final BlockManager STAINED_ACACIA_BOARDS = BlockManager.register("stained_acacia_boards", BlockProps.PLANK.get(), CaliberBlockHelper.modifyList(PLANK_VARIANTS, (c) -> c.add(ModBlockFamily.Variant.BASE)));
    public static final BlockManager STAINED_BIRCH_BOARDS = BlockManager.register("stained_birch_boards", BlockProps.PLANK.get(), CaliberBlockHelper.modifyList(PLANK_VARIANTS, (c) -> c.add(ModBlockFamily.Variant.BASE)));
    public static final BlockManager STAINED_DARK_OAK_BOARDS = BlockManager.register("stained_dark_oak_boards", BlockProps.PLANK.get(), CaliberBlockHelper.modifyList(PLANK_VARIANTS, (c) -> c.add(ModBlockFamily.Variant.BASE)));
    public static final BlockManager STAINED_JUNGLE_BOARDS = BlockManager.register("stained_jungle_boards", BlockProps.PLANK.get(), CaliberBlockHelper.modifyList(PLANK_VARIANTS, (c) -> c.add(ModBlockFamily.Variant.BASE)));
    public static final BlockManager STAINED_OAK_BOARDS = BlockManager.register("stained_oak_boards", BlockProps.PLANK.get(), CaliberBlockHelper.modifyList(PLANK_VARIANTS, (c) -> c.add(ModBlockFamily.Variant.BASE)));
    public static final BlockManager STAINED_SPRUCE_BOARDS = BlockManager.register("stained_spruce_boards", BlockProps.PLANK.get(), CaliberBlockHelper.modifyList(PLANK_VARIANTS, (c) -> c.add(ModBlockFamily.Variant.BASE)));
    ...
    public static final BlockManager MOSSY_STAINED_ACACIA_BOARDS = BlockManager.register("mossy_stained_acacia_boards", BlockProps.PLANK.get(), CaliberBlockHelper.modifyList(PLANK_VARIANTS, (c) -> c.add(ModBlockFamily.Variant.BASE)));
    public static final BlockManager MOSSY_STAINED_BIRCH_BOARDS = BlockManager.register("mossy_stained_birch_boards", BlockProps.PLANK.get(), CaliberBlockHelper.modifyList(PLANK_VARIANTS, (c) -> c.add(ModBlockFamily.Variant.BASE)));
    public static final BlockManager MOSSY_STAINED_DARK_OAK_BOARDS = BlockManager.register("mossy_stained_dark_oak_boards", BlockProps.PLANK.get(), CaliberBlockHelper.modifyList(PLANK_VARIANTS, (c) -> c.add(ModBlockFamily.Variant.BASE)));
    public static final BlockManager MOSSY_STAINED_JUNGLE_BOARDS = BlockManager.register("mossy_stained_jungle_boards", BlockProps.PLANK.get(), CaliberBlockHelper.modifyList(PLANK_VARIANTS, (c) -> c.add(ModBlockFamily.Variant.BASE)));
    public static final BlockManager MOSSY_STAINED_OAK_BOARDS = BlockManager.register("mossy_stained_oak_boards", BlockProps.PLANK.get(), CaliberBlockHelper.modifyList(PLANK_VARIANTS, (c) -> c.add(ModBlockFamily.Variant.BASE)));
    public static final BlockManager MOSSY_STAINED_SPRUCE_BOARDS = BlockManager.register("mossy_stained_spruce_boards", BlockProps.PLANK.get(), CaliberBlockHelper.modifyList(PLANK_VARIANTS, (c) -> c.add(ModBlockFamily.Variant.BASE)));
...
//    public static final BlockManager CLAY_TILE = BlockManager.register("clay_tile", BlockProps.PLANK.get(), CaliberBlockHelper.modifyList(ROOF_VARIANTS, (c) -> c.add(ModBlockFamily.Variant.BASE)));
    ...
    /* Concrete */
    public static final BlockManager BLACK_CONCRETE = BlockManager.register("black_concrete", BlockProps.CONCRETE.get(), () -> Blocks.BLACK_CONCRETE, VARIANTS);
    public static final BlockManager BLUE_CONCRETE = BlockManager.register("blue_concrete", BlockProps.CONCRETE.get(), () -> Blocks.BLUE_CONCRETE, VARIANTS);
    public static final BlockManager BROWN_CONCRETE = BlockManager.register("brown_concrete", BlockProps.CONCRETE.get(), () -> Blocks.BROWN_CONCRETE, VARIANTS);
    public static final BlockManager CYAN_CONCRETE = BlockManager.register("cyan_concrete", BlockProps.CONCRETE.get(), () -> Blocks.CYAN_CONCRETE, VARIANTS);
    public static final BlockManager GRAY_CONCRETE = BlockManager.register("gray_concrete", BlockProps.CONCRETE.get(), () -> Blocks.GRAY_CONCRETE, VARIANTS);
    public static final BlockManager GREEN_CONCRETE = BlockManager.register("green_concrete", BlockProps.CONCRETE.get(), () -> Blocks.GREEN_CONCRETE, VARIANTS);
    public static final BlockManager LIGHT_BLUE_CONCRETE = BlockManager.register("light_blue_concrete", BlockProps.CONCRETE.get(), () -> Blocks.LIGHT_BLUE_CONCRETE, VARIANTS);
    public static final BlockManager LIGHT_GRAY_CONCRETE = BlockManager.register("light_gray_concrete", BlockProps.CONCRETE.get(), () -> Blocks.LIGHT_GRAY_CONCRETE, VARIANTS);
    public static final BlockManager LIME_CONCRETE = BlockManager.register("lime_concrete", BlockProps.CONCRETE.get(), () -> Blocks.LIME_CONCRETE, VARIANTS);
    public static final BlockManager MAGENTA_CONCRETE = BlockManager.register("magenta_concrete", BlockProps.CONCRETE.get(), () -> Blocks.MAGENTA_CONCRETE, VARIANTS);
    public static final BlockManager ORANGE_CONCRETE = BlockManager.register("orange_concrete", BlockProps.CONCRETE.get(), () -> Blocks.ORANGE_CONCRETE, VARIANTS);
    public static final BlockManager PINK_CONCRETE = BlockManager.register("pink_concrete", BlockProps.CONCRETE.get(), () -> Blocks.PINK_CONCRETE, VARIANTS);
    public static final BlockManager PURPLE_CONCRETE = BlockManager.register("purple_concrete", BlockProps.CONCRETE.get(), () -> Blocks.PURPLE_CONCRETE, VARIANTS);
    public static final BlockManager RED_CONCRETE = BlockManager.register("red_concrete", BlockProps.CONCRETE.get(), () -> Blocks.RED_CONCRETE, VARIANTS);
    public static final BlockManager WHITE_CONCRETE = BlockManager.register("white_concrete", BlockProps.CONCRETE.get(), () -> Blocks.WHITE_CONCRETE, VARIANTS);
    public static final BlockManager YELLOW_CONCRETE = BlockManager.register("yellow_concrete", BlockProps.CONCRETE.get(), () -> Blocks.YELLOW_CONCRETE, VARIANTS);
    ...
    /* Plaster */
    public static final BlockManager BEIGE_PLASTER = BlockManager.register("beige_plaster", BlockProps.PLASTER.get(), CaliberBlockHelper.modifyList(VARIANTS, (c) -> c.add(ModBlockFamily.Variant.BASE)));
    public static final BlockManager BROWN_PLASTER = BlockManager.register("brown_plaster", BlockProps.PLASTER.get(), CaliberBlockHelper.modifyList(VARIANTS, (c) -> c.add(ModBlockFamily.Variant.BASE)));
    public static final BlockManager OCHRE_PLASTER = BlockManager.register("ochre_plaster", BlockProps.PLASTER.get(), CaliberBlockHelper.modifyList(VARIANTS, (c) -> c.add(ModBlockFamily.Variant.BASE)));
    public static final BlockManager TAN_PLASTER = BlockManager.register("tan_plaster", BlockProps.PLASTER.get(), CaliberBlockHelper.modifyList(VARIANTS, (c) -> c.add(ModBlockFamily.Variant.BASE)));
    public static final BlockManager WHITE_PLASTER = BlockManager.register("white_plaster", BlockProps.PLASTER.get(), CaliberBlockHelper.modifyList(VARIANTS, (c) -> c.add(ModBlockFamily.Variant.BASE)));
    ...
    public static final BlockManager TUDOR_ACACIA_BEIGE_PLASTER_HORIZONTAL_1 = BlockManager.register("tudor_acacia_beige_plaster_horizontal_1", BlockProps.TUDOR_1.get(), CaliberBlockHelper.modifyList(CaliberBlockHelper.TUDOR_VARIANTS, (c) -> c.add(ModBlockFamily.Variant.BASE)));
    public static final BlockManager TUDOR_ACACIA_BEIGE_PLASTER_HORIZONTAL_2 = BlockManager.register("tudor_acacia_beige_plaster_horizontal_2", BlockProps.TUDOR_2.get(), CaliberBlockHelper.modifyList(CaliberBlockHelper.TUDOR_VARIANTS, (c) -> c.add(ModBlockFamily.Variant.BASE)));
    public static final BlockManager TUDOR_ACACIA_BEIGE_PLASTER_VERTICAL_1 = BlockManager.register("tudor_acacia_beige_plaster_vertical_1", BlockProps.TUDOR_1.get(), CaliberBlockHelper.modifyList(CaliberBlockHelper.TUDOR_VARIANTS, (c) -> c.add(ModBlockFamily.Variant.BASE)));
    public static final BlockManager TUDOR_ACACIA_BEIGE_PLASTER_VERTICAL_2 = BlockManager.register("tudor_acacia_beige_plaster_vertical_2", BlockProps.TUDOR_2.get(), CaliberBlockHelper.modifyList(CaliberBlockHelper.TUDOR_VARIANTS, (c) -> c.add(ModBlockFamily.Variant.BASE)));
    ...
    public static final BlockManager TUDOR_BIRCH_BEIGE_PLASTER_HORIZONTAL_1 = BlockManager.register("tudor_birch_beige_plaster_horizontal_1", BlockProps.TUDOR_1.get(), CaliberBlockHelper.modifyList(CaliberBlockHelper.TUDOR_VARIANTS, (c) -> c.add(ModBlockFamily.Variant.BASE)));
    public static final BlockManager TUDOR_BIRCH_BEIGE_PLASTER_HORIZONTAL_2 = BlockManager.register("tudor_birch_beige_plaster_horizontal_2", BlockProps.TUDOR_2.get(), CaliberBlockHelper.modifyList(CaliberBlockHelper.TUDOR_VARIANTS, (c) -> c.add(ModBlockFamily.Variant.BASE)));
    public static final BlockManager TUDOR_BIRCH_BEIGE_PLASTER_VERTICAL_1 = BlockManager.register("tudor_birch_beige_plaster_vertical_1", BlockProps.TUDOR_1.get(), CaliberBlockHelper.modifyList(CaliberBlockHelper.TUDOR_VARIANTS, (c) -> c.add(ModBlockFamily.Variant.BASE)));
    public static final BlockManager TUDOR_BIRCH_BEIGE_PLASTER_VERTICAL_2 = BlockManager.register("tudor_birch_beige_plaster_vertical_2", BlockProps.TUDOR_2.get(), CaliberBlockHelper.modifyList(CaliberBlockHelper.TUDOR_VARIANTS, (c) -> c.add(ModBlockFamily.Variant.BASE)));
    ...
    public static final BlockManager TUDOR_DARK_OAK_BEIGE_PLASTER_HORIZONTAL_1 = BlockManager.register("tudor_dark_oak_beige_plaster_horizontal_1", BlockProps.TUDOR_1.get(), CaliberBlockHelper.modifyList(CaliberBlockHelper.TUDOR_VARIANTS, (c) -> c.add(ModBlockFamily.Variant.BASE)));
    public static final BlockManager TUDOR_DARK_OAK_BEIGE_PLASTER_HORIZONTAL_2 = BlockManager.register("tudor_dark_oak_beige_plaster_horizontal_2", BlockProps.TUDOR_2.get(), CaliberBlockHelper.modifyList(CaliberBlockHelper.TUDOR_VARIANTS, (c) -> c.add(ModBlockFamily.Variant.BASE)));
    public static final BlockManager TUDOR_DARK_OAK_BEIGE_PLASTER_VERTICAL_1 = BlockManager.register("tudor_dark_oak_beige_plaster_vertical_1", BlockProps.TUDOR_1.get(), CaliberBlockHelper.modifyList(CaliberBlockHelper.TUDOR_VARIANTS, (c) -> c.add(ModBlockFamily.Variant.BASE)));
    public static final BlockManager TUDOR_DARK_OAK_BEIGE_PLASTER_VERTICAL_2 = BlockManager.register("tudor_dark_oak_beige_plaster_vertical_2", BlockProps.TUDOR_2.get(), CaliberBlockHelper.modifyList(CaliberBlockHelper.TUDOR_VARIANTS, (c) -> c.add(ModBlockFamily.Variant.BASE)));
    ...
    public static final BlockManager TUDOR_JUNGLE_BEIGE_PLASTER_HORIZONTAL_1 = BlockManager.register("tudor_jungle_beige_plaster_horizontal_1", BlockProps.TUDOR_1.get(), CaliberBlockHelper.modifyList(CaliberBlockHelper.TUDOR_VARIANTS, (c) -> c.add(ModBlockFamily.Variant.BASE)));
    public static final BlockManager TUDOR_JUNGLE_BEIGE_PLASTER_HORIZONTAL_2 = BlockManager.register("tudor_jungle_beige_plaster_horizontal_2", BlockProps.TUDOR_2.get(), CaliberBlockHelper.modifyList(CaliberBlockHelper.TUDOR_VARIANTS, (c) -> c.add(ModBlockFamily.Variant.BASE)));
    public static final BlockManager TUDOR_JUNGLE_BEIGE_PLASTER_VERTICAL_1 = BlockManager.register("tudor_jungle_beige_plaster_vertical_1", BlockProps.TUDOR_1.get(), CaliberBlockHelper.modifyList(CaliberBlockHelper.TUDOR_VARIANTS, (c) -> c.add(ModBlockFamily.Variant.BASE)));
    public static final BlockManager TUDOR_JUNGLE_BEIGE_PLASTER_VERTICAL_2 = BlockManager.register("tudor_jungle_beige_plaster_vertical_2", BlockProps.TUDOR_2.get(), CaliberBlockHelper.modifyList(CaliberBlockHelper.TUDOR_VARIANTS, (c) -> c.add(ModBlockFamily.Variant.BASE)));
    ...
    public static final BlockManager TUDOR_OAK_BEIGE_PLASTER_HORIZONTAL_1 = BlockManager.register("tudor_oak_beige_plaster_horizontal_1", BlockProps.TUDOR_1.get(), CaliberBlockHelper.modifyList(CaliberBlockHelper.TUDOR_VARIANTS, (c) -> c.add(ModBlockFamily.Variant.BASE)));
    public static final BlockManager TUDOR_OAK_BEIGE_PLASTER_HORIZONTAL_2 = BlockManager.register("tudor_oak_beige_plaster_horizontal_2", BlockProps.TUDOR_2.get(), CaliberBlockHelper.modifyList(CaliberBlockHelper.TUDOR_VARIANTS, (c) -> c.add(ModBlockFamily.Variant.BASE)));
    public static final BlockManager TUDOR_OAK_BEIGE_PLASTER_VERTICAL_1 = BlockManager.register("tudor_oak_beige_plaster_vertical_1", BlockProps.TUDOR_1.get(), CaliberBlockHelper.modifyList(CaliberBlockHelper.TUDOR_VARIANTS, (c) -> c.add(ModBlockFamily.Variant.BASE)));
    public static final BlockManager TUDOR_OAK_BEIGE_PLASTER_VERTICAL_2 = BlockManager.register("tudor_oak_beige_plaster_vertical_2", BlockProps.TUDOR_2.get(), CaliberBlockHelper.modifyList(CaliberBlockHelper.TUDOR_VARIANTS, (c) -> c.add(ModBlockFamily.Variant.BASE)));
    ...
    public static final BlockManager TUDOR_SPRUCE_BEIGE_PLASTER_HORIZONTAL_1 = BlockManager.register("tudor_spruce_beige_plaster_horizontal_1", BlockProps.TUDOR_1.get(), CaliberBlockHelper.modifyList(CaliberBlockHelper.TUDOR_VARIANTS, (c) -> c.add(ModBlockFamily.Variant.BASE)));
    public static final BlockManager TUDOR_SPRUCE_BEIGE_PLASTER_HORIZONTAL_2 = BlockManager.register("tudor_spruce_beige_plaster_horizontal_2", BlockProps.TUDOR_2.get(), CaliberBlockHelper.modifyList(CaliberBlockHelper.TUDOR_VARIANTS, (c) -> c.add(ModBlockFamily.Variant.BASE)));
    public static final BlockManager TUDOR_SPRUCE_BEIGE_PLASTER_VERTICAL_1 = BlockManager.register("tudor_spruce_beige_plaster_vertical_1", BlockProps.TUDOR_1.get(), CaliberBlockHelper.modifyList(CaliberBlockHelper.TUDOR_VARIANTS, (c) -> c.add(ModBlockFamily.Variant.BASE)));
    public static final BlockManager TUDOR_SPRUCE_BEIGE_PLASTER_VERTICAL_2 = BlockManager.register("tudor_spruce_beige_plaster_vertical_2", BlockProps.TUDOR_2.get(), CaliberBlockHelper.modifyList(CaliberBlockHelper.TUDOR_VARIANTS, (c) -> c.add(ModBlockFamily.Variant.BASE)));
    ...
    public static final BlockManager TUDOR_ACACIA_WHITE_PLASTER_HORIZONTAL_1 = BlockManager.register("tudor_acacia_white_plaster_horizontal_1", BlockProps.TUDOR_1.get(), CaliberBlockHelper.modifyList(CaliberBlockHelper.TUDOR_VARIANTS, (c) -> c.add(ModBlockFamily.Variant.BASE)));
    public static final BlockManager TUDOR_ACACIA_WHITE_PLASTER_HORIZONTAL_2 = BlockManager.register("tudor_acacia_white_plaster_horizontal_2", BlockProps.TUDOR_2.get(), CaliberBlockHelper.modifyList(CaliberBlockHelper.TUDOR_VARIANTS, (c) -> c.add(ModBlockFamily.Variant.BASE)));
    public static final BlockManager TUDOR_ACACIA_WHITE_PLASTER_VERTICAL_1 = BlockManager.register("tudor_acacia_white_plaster_vertical_1", BlockProps.TUDOR_1.get(), CaliberBlockHelper.modifyList(CaliberBlockHelper.TUDOR_VARIANTS, (c) -> c.add(ModBlockFamily.Variant.BASE)));
    public static final BlockManager TUDOR_ACACIA_WHITE_PLASTER_VERTICAL_2 = BlockManager.register("tudor_acacia_white_plaster_vertical_2", BlockProps.TUDOR_2.get(), CaliberBlockHelper.modifyList(CaliberBlockHelper.TUDOR_VARIANTS, (c) -> c.add(ModBlockFamily.Variant.BASE)));
    ...
    public static final BlockManager TUDOR_BIRCH_WHITE_PLASTER_HORIZONTAL_1 = BlockManager.register("tudor_birch_white_plaster_horizontal_1", BlockProps.TUDOR_1.get(), CaliberBlockHelper.modifyList(CaliberBlockHelper.TUDOR_VARIANTS, (c) -> c.add(ModBlockFamily.Variant.BASE)));
    public static final BlockManager TUDOR_BIRCH_WHITE_PLASTER_HORIZONTAL_2 = BlockManager.register("tudor_birch_white_plaster_horizontal_2", BlockProps.TUDOR_2.get(), CaliberBlockHelper.modifyList(CaliberBlockHelper.TUDOR_VARIANTS, (c) -> c.add(ModBlockFamily.Variant.BASE)));
    public static final BlockManager TUDOR_BIRCH_WHITE_PLASTER_VERTICAL_1 = BlockManager.register("tudor_birch_white_plaster_vertical_1", BlockProps.TUDOR_1.get(), CaliberBlockHelper.modifyList(CaliberBlockHelper.TUDOR_VARIANTS, (c) -> c.add(ModBlockFamily.Variant.BASE)));
    public static final BlockManager TUDOR_BIRCH_WHITE_PLASTER_VERTICAL_2 = BlockManager.register("tudor_birch_white_plaster_vertical_2", BlockProps.TUDOR_2.get(), CaliberBlockHelper.modifyList(CaliberBlockHelper.TUDOR_VARIANTS, (c) -> c.add(ModBlockFamily.Variant.BASE)));
    ...
    public static final BlockManager TUDOR_DARK_OAK_WHITE_PLASTER_HORIZONTAL_1 = BlockManager.register("tudor_dark_oak_white_plaster_horizontal_1", BlockProps.TUDOR_1.get(), CaliberBlockHelper.modifyList(CaliberBlockHelper.TUDOR_VARIANTS, (c) -> c.add(ModBlockFamily.Variant.BASE)));
    public static final BlockManager TUDOR_DARK_OAK_WHITE_PLASTER_HORIZONTAL_2 = BlockManager.register("tudor_dark_oak_white_plaster_horizontal_2", BlockProps.TUDOR_2.get(), CaliberBlockHelper.modifyList(CaliberBlockHelper.TUDOR_VARIANTS, (c) -> c.add(ModBlockFamily.Variant.BASE)));
    public static final BlockManager TUDOR_DARK_OAK_WHITE_PLASTER_VERTICAL_1 = BlockManager.register("tudor_dark_oak_white_plaster_vertical_1", BlockProps.TUDOR_1.get(), CaliberBlockHelper.modifyList(CaliberBlockHelper.TUDOR_VARIANTS, (c) -> c.add(ModBlockFamily.Variant.BASE)));
    public static final BlockManager TUDOR_DARK_OAK_WHITE_PLASTER_VERTICAL_2 = BlockManager.register("tudor_dark_oak_white_plaster_vertical_2", BlockProps.TUDOR_2.get(), CaliberBlockHelper.modifyList(CaliberBlockHelper.TUDOR_VARIANTS, (c) -> c.add(ModBlockFamily.Variant.BASE)));
    ...
    public static final BlockManager TUDOR_JUNGLE_WHITE_PLASTER_HORIZONTAL_1 = BlockManager.register("tudor_jungle_white_plaster_horizontal_1", BlockProps.TUDOR_1.get(), CaliberBlockHelper.modifyList(CaliberBlockHelper.TUDOR_VARIANTS, (c) -> c.add(ModBlockFamily.Variant.BASE)));
    public static final BlockManager TUDOR_JUNGLE_WHITE_PLASTER_HORIZONTAL_2 = BlockManager.register("tudor_jungle_white_plaster_horizontal_2", BlockProps.TUDOR_2.get(), CaliberBlockHelper.modifyList(CaliberBlockHelper.TUDOR_VARIANTS, (c) -> c.add(ModBlockFamily.Variant.BASE)));
    public static final BlockManager TUDOR_JUNGLE_WHITE_PLASTER_VERTICAL_1 = BlockManager.register("tudor_jungle_white_plaster_vertical_1", BlockProps.TUDOR_1.get(), CaliberBlockHelper.modifyList(CaliberBlockHelper.TUDOR_VARIANTS, (c) -> c.add(ModBlockFamily.Variant.BASE)));
    public static final BlockManager TUDOR_JUNGLE_WHITE_PLASTER_VERTICAL_2 = BlockManager.register("tudor_jungle_white_plaster_vertical_2", BlockProps.TUDOR_2.get(), CaliberBlockHelper.modifyList(CaliberBlockHelper.TUDOR_VARIANTS, (c) -> c.add(ModBlockFamily.Variant.BASE)));
    ...
    public static final BlockManager TUDOR_OAK_WHITE_PLASTER_HORIZONTAL_1 = BlockManager.register("tudor_oak_white_plaster_horizontal_1", BlockProps.TUDOR_1.get(), CaliberBlockHelper.modifyList(CaliberBlockHelper.TUDOR_VARIANTS, (c) -> c.add(ModBlockFamily.Variant.BASE)));
    public static final BlockManager TUDOR_OAK_WHITE_PLASTER_HORIZONTAL_2 = BlockManager.register("tudor_oak_white_plaster_horizontal_2", BlockProps.TUDOR_2.get(), CaliberBlockHelper.modifyList(CaliberBlockHelper.TUDOR_VARIANTS, (c) -> c.add(ModBlockFamily.Variant.BASE)));
    public static final BlockManager TUDOR_OAK_WHITE_PLASTER_VERTICAL_1 = BlockManager.register("tudor_oak_white_plaster_vertical_1", BlockProps.TUDOR_1.get(), CaliberBlockHelper.modifyList(CaliberBlockHelper.TUDOR_VARIANTS, (c) -> c.add(ModBlockFamily.Variant.BASE)));
    public static final BlockManager TUDOR_OAK_WHITE_PLASTER_VERTICAL_2 = BlockManager.register("tudor_oak_white_plaster_vertical_2", BlockProps.TUDOR_2.get(), CaliberBlockHelper.modifyList(CaliberBlockHelper.TUDOR_VARIANTS, (c) -> c.add(ModBlockFamily.Variant.BASE)));
    ...
    public static final BlockManager TUDOR_SPRUCE_WHITE_PLASTER_HORIZONTAL_1 = BlockManager.register("tudor_spruce_white_plaster_horizontal_1", BlockProps.TUDOR_1.get(), CaliberBlockHelper.modifyList(CaliberBlockHelper.TUDOR_VARIANTS, (c) -> c.add(ModBlockFamily.Variant.BASE)));
    public static final BlockManager TUDOR_SPRUCE_WHITE_PLASTER_HORIZONTAL_2 = BlockManager.register("tudor_spruce_white_plaster_horizontal_2", BlockProps.TUDOR_2.get(), CaliberBlockHelper.modifyList(CaliberBlockHelper.TUDOR_VARIANTS, (c) -> c.add(ModBlockFamily.Variant.BASE)));
    public static final BlockManager TUDOR_SPRUCE_WHITE_PLASTER_VERTICAL_1 = BlockManager.register("tudor_spruce_white_plaster_vertical_1", BlockProps.TUDOR_1.get(), CaliberBlockHelper.modifyList(CaliberBlockHelper.TUDOR_VARIANTS, (c) -> c.add(ModBlockFamily.Variant.BASE)));
    public static final BlockManager TUDOR_SPRUCE_WHITE_PLASTER_VERTICAL_2 = BlockManager.register("tudor_spruce_white_plaster_vertical_2", BlockProps.TUDOR_2.get(), CaliberBlockHelper.modifyList(CaliberBlockHelper.TUDOR_VARIANTS, (c) -> c.add(ModBlockFamily.Variant.BASE)));
    ...
    public static final BlockManager TUDOR_STAINED_ACACIA_BEIGE_PLASTER_HORIZONTAL_1 = BlockManager.register("tudor_stained_acacia_beige_plaster_horizontal_1", BlockProps.TUDOR_1.get(), CaliberBlockHelper.modifyList(CaliberBlockHelper.TUDOR_VARIANTS, (c) -> c.add(ModBlockFamily.Variant.BASE)));
    public static final BlockManager TUDOR_STAINED_ACACIA_BEIGE_PLASTER_HORIZONTAL_2 = BlockManager.register("tudor_stained_acacia_beige_plaster_horizontal_2", BlockProps.TUDOR_2.get(), CaliberBlockHelper.modifyList(CaliberBlockHelper.TUDOR_VARIANTS, (c) -> c.add(ModBlockFamily.Variant.BASE)));
    public static final BlockManager TUDOR_STAINED_ACACIA_BEIGE_PLASTER_VERTICAL_1 = BlockManager.register("tudor_stained_acacia_beige_plaster_vertical_1", BlockProps.TUDOR_1.get(), CaliberBlockHelper.modifyList(CaliberBlockHelper.TUDOR_VARIANTS, (c) -> c.add(ModBlockFamily.Variant.BASE)));
    public static final BlockManager TUDOR_STAINED_ACACIA_BEIGE_PLASTER_VERTICAL_2 = BlockManager.register("tudor_stained_acacia_beige_plaster_vertical_2", BlockProps.TUDOR_2.get(), CaliberBlockHelper.modifyList(CaliberBlockHelper.TUDOR_VARIANTS, (c) -> c.add(ModBlockFamily.Variant.BASE)));
    ...
    public static final BlockManager TUDOR_STAINED_BIRCH_BEIGE_PLASTER_HORIZONTAL_1 = BlockManager.register("tudor_stained_birch_beige_plaster_horizontal_1", BlockProps.TUDOR_1.get(), CaliberBlockHelper.modifyList(CaliberBlockHelper.TUDOR_VARIANTS, (c) -> c.add(ModBlockFamily.Variant.BASE)));
    public static final BlockManager TUDOR_STAINED_BIRCH_BEIGE_PLASTER_HORIZONTAL_2 = BlockManager.register("tudor_stained_birch_beige_plaster_horizontal_2", BlockProps.TUDOR_2.get(), CaliberBlockHelper.modifyList(CaliberBlockHelper.TUDOR_VARIANTS, (c) -> c.add(ModBlockFamily.Variant.BASE)));
    public static final BlockManager TUDOR_STAINED_BIRCH_BEIGE_PLASTER_VERTICAL_1 = BlockManager.register("tudor_stained_birch_beige_plaster_vertical_1", BlockProps.TUDOR_1.get(), CaliberBlockHelper.modifyList(CaliberBlockHelper.TUDOR_VARIANTS, (c) -> c.add(ModBlockFamily.Variant.BASE)));
    public static final BlockManager TUDOR_STAINED_BIRCH_BEIGE_PLASTER_VERTICAL_2 = BlockManager.register("tudor_stained_birch_beige_plaster_vertical_2", BlockProps.TUDOR_2.get(), CaliberBlockHelper.modifyList(CaliberBlockHelper.TUDOR_VARIANTS, (c) -> c.add(ModBlockFamily.Variant.BASE)));
    ...
    public static final BlockManager TUDOR_STAINED_DARK_OAK_BEIGE_PLASTER_HORIZONTAL_1 = BlockManager.register("tudor_stained_dark_oak_beige_plaster_horizontal_1", BlockProps.TUDOR_1.get(), CaliberBlockHelper.modifyList(CaliberBlockHelper.TUDOR_VARIANTS, (c) -> c.add(ModBlockFamily.Variant.BASE)));
    public static final BlockManager TUDOR_STAINED_DARK_OAK_BEIGE_PLASTER_HORIZONTAL_2 = BlockManager.register("tudor_stained_dark_oak_beige_plaster_horizontal_2", BlockProps.TUDOR_2.get(), CaliberBlockHelper.modifyList(CaliberBlockHelper.TUDOR_VARIANTS, (c) -> c.add(ModBlockFamily.Variant.BASE)));
    public static final BlockManager TUDOR_STAINED_DARK_OAK_BEIGE_PLASTER_VERTICAL_1 = BlockManager.register("tudor_stained_dark_oak_beige_plaster_vertical_1", BlockProps.TUDOR_1.get(), CaliberBlockHelper.modifyList(CaliberBlockHelper.TUDOR_VARIANTS, (c) -> c.add(ModBlockFamily.Variant.BASE)));
    public static final BlockManager TUDOR_STAINED_DARK_OAK_BEIGE_PLASTER_VERTICAL_2 = BlockManager.register("tudor_stained_dark_oak_beige_plaster_vertical_2", BlockProps.TUDOR_2.get(), CaliberBlockHelper.modifyList(CaliberBlockHelper.TUDOR_VARIANTS, (c) -> c.add(ModBlockFamily.Variant.BASE)));
    ...
    public static final BlockManager TUDOR_STAINED_JUNGLE_BEIGE_PLASTER_HORIZONTAL_1 = BlockManager.register("tudor_stained_jungle_beige_plaster_horizontal_1", BlockProps.TUDOR_1.get(), CaliberBlockHelper.modifyList(CaliberBlockHelper.TUDOR_VARIANTS, (c) -> c.add(ModBlockFamily.Variant.BASE)));
    public static final BlockManager TUDOR_STAINED_JUNGLE_BEIGE_PLASTER_HORIZONTAL_2 = BlockManager.register("tudor_stained_jungle_beige_plaster_horizontal_2", BlockProps.TUDOR_2.get(), CaliberBlockHelper.modifyList(CaliberBlockHelper.TUDOR_VARIANTS, (c) -> c.add(ModBlockFamily.Variant.BASE)));
    public static final BlockManager TUDOR_STAINED_JUNGLE_BEIGE_PLASTER_VERTICAL_1 = BlockManager.register("tudor_stained_jungle_beige_plaster_vertical_1", BlockProps.TUDOR_1.get(), CaliberBlockHelper.modifyList(CaliberBlockHelper.TUDOR_VARIANTS, (c) -> c.add(ModBlockFamily.Variant.BASE)));
    public static final BlockManager TUDOR_STAINED_JUNGLE_BEIGE_PLASTER_VERTICAL_2 = BlockManager.register("tudor_stained_jungle_beige_plaster_vertical_2", BlockProps.TUDOR_2.get(), CaliberBlockHelper.modifyList(CaliberBlockHelper.TUDOR_VARIANTS, (c) -> c.add(ModBlockFamily.Variant.BASE)));
    ...
    public static final BlockManager TUDOR_STAINED_OAK_BEIGE_PLASTER_HORIZONTAL_1 = BlockManager.register("tudor_stained_oak_beige_plaster_horizontal_1", BlockProps.TUDOR_1.get(), CaliberBlockHelper.modifyList(CaliberBlockHelper.TUDOR_VARIANTS, (c) -> c.add(ModBlockFamily.Variant.BASE)));
    public static final BlockManager TUDOR_STAINED_OAK_BEIGE_PLASTER_HORIZONTAL_2 = BlockManager.register("tudor_stained_oak_beige_plaster_horizontal_2", BlockProps.TUDOR_2.get(), CaliberBlockHelper.modifyList(CaliberBlockHelper.TUDOR_VARIANTS, (c) -> c.add(ModBlockFamily.Variant.BASE)));
    public static final BlockManager TUDOR_STAINED_OAK_BEIGE_PLASTER_VERTICAL_1 = BlockManager.register("tudor_stained_oak_beige_plaster_vertical_1", BlockProps.TUDOR_1.get(), CaliberBlockHelper.modifyList(CaliberBlockHelper.TUDOR_VARIANTS, (c) -> c.add(ModBlockFamily.Variant.BASE)));
    public static final BlockManager TUDOR_STAINED_OAK_BEIGE_PLASTER_VERTICAL_2 = BlockManager.register("tudor_stained_oak_beige_plaster_vertical_2", BlockProps.TUDOR_2.get(), CaliberBlockHelper.modifyList(CaliberBlockHelper.TUDOR_VARIANTS, (c) -> c.add(ModBlockFamily.Variant.BASE)));
    ...
    public static final BlockManager TUDOR_STAINED_SPRUCE_BEIGE_PLASTER_HORIZONTAL_1 = BlockManager.register("tudor_stained_spruce_beige_plaster_horizontal_1", BlockProps.TUDOR_1.get(), CaliberBlockHelper.modifyList(CaliberBlockHelper.TUDOR_VARIANTS, (c) -> c.add(ModBlockFamily.Variant.BASE)));
    public static final BlockManager TUDOR_STAINED_SPRUCE_BEIGE_PLASTER_HORIZONTAL_2 = BlockManager.register("tudor_stained_spruce_beige_plaster_horizontal_2", BlockProps.TUDOR_2.get(), CaliberBlockHelper.modifyList(CaliberBlockHelper.TUDOR_VARIANTS, (c) -> c.add(ModBlockFamily.Variant.BASE)));
    public static final BlockManager TUDOR_STAINED_SPRUCE_BEIGE_PLASTER_VERTICAL_1 = BlockManager.register("tudor_stained_spruce_beige_plaster_vertical_1", BlockProps.TUDOR_1.get(), CaliberBlockHelper.modifyList(CaliberBlockHelper.TUDOR_VARIANTS, (c) -> c.add(ModBlockFamily.Variant.BASE)));
    public static final BlockManager TUDOR_STAINED_SPRUCE_BEIGE_PLASTER_VERTICAL_2 = BlockManager.register("tudor_stained_spruce_beige_plaster_vertical_2", BlockProps.TUDOR_2.get(), CaliberBlockHelper.modifyList(CaliberBlockHelper.TUDOR_VARIANTS, (c) -> c.add(ModBlockFamily.Variant.BASE)));
    ...
    public static final BlockManager TUDOR_STAINED_ACACIA_WHITE_PLASTER_HORIZONTAL_1 = BlockManager.register("tudor_stained_acacia_white_plaster_horizontal_1", BlockProps.TUDOR_1.get(), CaliberBlockHelper.modifyList(CaliberBlockHelper.TUDOR_VARIANTS, (c) -> c.add(ModBlockFamily.Variant.BASE)));
    public static final BlockManager TUDOR_STAINED_ACACIA_WHITE_PLASTER_HORIZONTAL_2 = BlockManager.register("tudor_stained_acacia_white_plaster_horizontal_2", BlockProps.TUDOR_2.get(), CaliberBlockHelper.modifyList(CaliberBlockHelper.TUDOR_VARIANTS, (c) -> c.add(ModBlockFamily.Variant.BASE)));
    public static final BlockManager TUDOR_STAINED_ACACIA_WHITE_PLASTER_VERTICAL_1 = BlockManager.register("tudor_stained_acacia_white_plaster_vertical_1", BlockProps.TUDOR_1.get(), CaliberBlockHelper.modifyList(CaliberBlockHelper.TUDOR_VARIANTS, (c) -> c.add(ModBlockFamily.Variant.BASE)));
    public static final BlockManager TUDOR_STAINED_ACACIA_WHITE_PLASTER_VERTICAL_2 = BlockManager.register("tudor_stained_acacia_white_plaster_vertical_2", BlockProps.TUDOR_2.get(), CaliberBlockHelper.modifyList(CaliberBlockHelper.TUDOR_VARIANTS, (c) -> c.add(ModBlockFamily.Variant.BASE)));
    ...
    public static final BlockManager TUDOR_STAINED_BIRCH_WHITE_PLASTER_HORIZONTAL_1 = BlockManager.register("tudor_stained_birch_white_plaster_horizontal_1", BlockProps.TUDOR_1.get(), CaliberBlockHelper.modifyList(CaliberBlockHelper.TUDOR_VARIANTS, (c) -> c.add(ModBlockFamily.Variant.BASE)));
    public static final BlockManager TUDOR_STAINED_BIRCH_WHITE_PLASTER_HORIZONTAL_2 = BlockManager.register("tudor_stained_birch_white_plaster_horizontal_2", BlockProps.TUDOR_2.get(), CaliberBlockHelper.modifyList(CaliberBlockHelper.TUDOR_VARIANTS, (c) -> c.add(ModBlockFamily.Variant.BASE)));
    public static final BlockManager TUDOR_STAINED_BIRCH_WHITE_PLASTER_VERTICAL_1 = BlockManager.register("tudor_stained_birch_white_plaster_vertical_1", BlockProps.TUDOR_1.get(), CaliberBlockHelper.modifyList(CaliberBlockHelper.TUDOR_VARIANTS, (c) -> c.add(ModBlockFamily.Variant.BASE)));
    public static final BlockManager TUDOR_STAINED_BIRCH_WHITE_PLASTER_VERTICAL_2 = BlockManager.register("tudor_stained_birch_white_plaster_vertical_2", BlockProps.TUDOR_2.get(), CaliberBlockHelper.modifyList(CaliberBlockHelper.TUDOR_VARIANTS, (c) -> c.add(ModBlockFamily.Variant.BASE)));
    ...
    public static final BlockManager TUDOR_STAINED_DARK_OAK_WHITE_PLASTER_HORIZONTAL_1 = BlockManager.register("tudor_stained_dark_oak_white_plaster_horizontal_1", BlockProps.TUDOR_1.get(), CaliberBlockHelper.modifyList(CaliberBlockHelper.TUDOR_VARIANTS, (c) -> c.add(ModBlockFamily.Variant.BASE)));
    public static final BlockManager TUDOR_STAINED_DARK_OAK_WHITE_PLASTER_HORIZONTAL_2 = BlockManager.register("tudor_stained_dark_oak_white_plaster_horizontal_2", BlockProps.TUDOR_2.get(), CaliberBlockHelper.modifyList(CaliberBlockHelper.TUDOR_VARIANTS, (c) -> c.add(ModBlockFamily.Variant.BASE)));
    public static final BlockManager TUDOR_STAINED_DARK_OAK_WHITE_PLASTER_VERTICAL_1 = BlockManager.register("tudor_stained_dark_oak_white_plaster_vertical_1", BlockProps.TUDOR_1.get(), CaliberBlockHelper.modifyList(CaliberBlockHelper.TUDOR_VARIANTS, (c) -> c.add(ModBlockFamily.Variant.BASE)));
    public static final BlockManager TUDOR_STAINED_DARK_OAK_WHITE_PLASTER_VERTICAL_2 = BlockManager.register("tudor_stained_dark_oak_white_plaster_vertical_2", BlockProps.TUDOR_2.get(), CaliberBlockHelper.modifyList(CaliberBlockHelper.TUDOR_VARIANTS, (c) -> c.add(ModBlockFamily.Variant.BASE)));
    ...
    public static final BlockManager TUDOR_STAINED_JUNGLE_WHITE_PLASTER_HORIZONTAL_1 = BlockManager.register("tudor_stained_jungle_white_plaster_horizontal_1", BlockProps.TUDOR_1.get(), CaliberBlockHelper.modifyList(CaliberBlockHelper.TUDOR_VARIANTS, (c) -> c.add(ModBlockFamily.Variant.BASE)));
    public static final BlockManager TUDOR_STAINED_JUNGLE_WHITE_PLASTER_HORIZONTAL_2 = BlockManager.register("tudor_stained_jungle_white_plaster_horizontal_2", BlockProps.TUDOR_2.get(), CaliberBlockHelper.modifyList(CaliberBlockHelper.TUDOR_VARIANTS, (c) -> c.add(ModBlockFamily.Variant.BASE)));
    public static final BlockManager TUDOR_STAINED_JUNGLE_WHITE_PLASTER_VERTICAL_1 = BlockManager.register("tudor_stained_jungle_white_plaster_vertical_1", BlockProps.TUDOR_1.get(), CaliberBlockHelper.modifyList(CaliberBlockHelper.TUDOR_VARIANTS, (c) -> c.add(ModBlockFamily.Variant.BASE)));
    public static final BlockManager TUDOR_STAINED_JUNGLE_WHITE_PLASTER_VERTICAL_2 = BlockManager.register("tudor_stained_jungle_white_plaster_vertical_2", BlockProps.TUDOR_2.get(), CaliberBlockHelper.modifyList(CaliberBlockHelper.TUDOR_VARIANTS, (c) -> c.add(ModBlockFamily.Variant.BASE)));
    ...
    public static final BlockManager TUDOR_STAINED_OAK_WHITE_PLASTER_HORIZONTAL_1 = BlockManager.register("tudor_stained_oak_white_plaster_horizontal_1", BlockProps.TUDOR_1.get(), CaliberBlockHelper.modifyList(CaliberBlockHelper.TUDOR_VARIANTS, (c) -> c.add(ModBlockFamily.Variant.BASE)));
    public static final BlockManager TUDOR_STAINED_OAK_WHITE_PLASTER_HORIZONTAL_2 = BlockManager.register("tudor_stained_oak_white_plaster_horizontal_2", BlockProps.TUDOR_2.get(), CaliberBlockHelper.modifyList(CaliberBlockHelper.TUDOR_VARIANTS, (c) -> c.add(ModBlockFamily.Variant.BASE)));
    public static final BlockManager TUDOR_STAINED_OAK_WHITE_PLASTER_VERTICAL_1 = BlockManager.register("tudor_stained_oak_white_plaster_vertical_1", BlockProps.TUDOR_1.get(), CaliberBlockHelper.modifyList(CaliberBlockHelper.TUDOR_VARIANTS, (c) -> c.add(ModBlockFamily.Variant.BASE)));
    public static final BlockManager TUDOR_STAINED_OAK_WHITE_PLASTER_VERTICAL_2 = BlockManager.register("tudor_stained_oak_white_plaster_vertical_2", BlockProps.TUDOR_2.get(), CaliberBlockHelper.modifyList(CaliberBlockHelper.TUDOR_VARIANTS, (c) -> c.add(ModBlockFamily.Variant.BASE)));
    ...
    public static final BlockManager TUDOR_STAINED_SPRUCE_WHITE_PLASTER_HORIZONTAL_1 = BlockManager.register("tudor_stained_spruce_white_plaster_horizontal_1", BlockProps.TUDOR_1.get(), CaliberBlockHelper.modifyList(CaliberBlockHelper.TUDOR_VARIANTS, (c) -> c.add(ModBlockFamily.Variant.BASE)));
    public static final BlockManager TUDOR_STAINED_SPRUCE_WHITE_PLASTER_HORIZONTAL_2 = BlockManager.register("tudor_stained_spruce_white_plaster_horizontal_2", BlockProps.TUDOR_2.get(), CaliberBlockHelper.modifyList(CaliberBlockHelper.TUDOR_VARIANTS, (c) -> c.add(ModBlockFamily.Variant.BASE)));
    public static final BlockManager TUDOR_STAINED_SPRUCE_WHITE_PLASTER_VERTICAL_1 = BlockManager.register("tudor_stained_spruce_white_plaster_vertical_1", BlockProps.TUDOR_1.get(), CaliberBlockHelper.modifyList(CaliberBlockHelper.TUDOR_VARIANTS, (c) -> c.add(ModBlockFamily.Variant.BASE)));
    public static final BlockManager TUDOR_STAINED_SPRUCE_WHITE_PLASTER_VERTICAL_2 = BlockManager.register("tudor_stained_spruce_white_plaster_vertical_2", BlockProps.TUDOR_2.get(), CaliberBlockHelper.modifyList(CaliberBlockHelper.TUDOR_VARIANTS, (c) -> c.add(ModBlockFamily.Variant.BASE)));
