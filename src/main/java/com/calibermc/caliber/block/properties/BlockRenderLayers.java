...
public class BlockRenderLayers {
    public static void set() {
        ...
        ItemBlockRenderTypes.setRenderLayer(ModBlocks.TALL_CRIMSON_DOOR.get(), RenderType.cutout());
        ItemBlockRenderTypes.setRenderLayer(ModBlocks.TALL_WARPED_DOOR.get(), RenderType.cutout());
