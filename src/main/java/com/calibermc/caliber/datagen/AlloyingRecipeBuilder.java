...
public class AlloyingRecipeBuilder implements RecipeBuilder {
    ...
    public AlloyingRecipeBuilder(ItemLike ingredient, ItemLike result, int count) {
    ...
    public void save(Consumer<FinishedRecipe> pFinishedRecipeConsumer, ResourceLocation pRecipeId) {
        ...
        pFinishedRecipeConsumer.accept(new AlloyingRecipeBuilder.Result(pRecipeId, this.result, this.count, this.ingredient,
    ...
    public static class Result implements FinishedRecipe {
        ...
        public ResourceLocation getId() {
            return new ResourceLocation(Caliber.MOD_ID,
                    ForgeRegistries.ITEMS.getKey(this.result).getPath() + "_from_alloying");
        }
