...
public class BiomesOPlentyBlockFamilies {
    ...
    /* Stone */
    public static final ModBlockFamily BOP_BLACK_SANDSTONE = familyBuilder(BOPBlocks.BLACK_SANDSTONE)
    ...
    public static final ModBlockFamily BOP_BRIMSTONE = familyBuilder(BOPBlocks.BRIMSTONE)
            .fromManager(BiomesOPlentyBlocks.BOP_BRIMSTONE)
            .getFamily();

    public static final ModBlockFamily BOP_BRIMSTONE_BRICKS = familyBuilder(BOPBlocks.BRIMSTONE_BRICKS)
    ...
    public static final ModBlockFamily BOP_CHISELED_BLACK_SANDSTONE = familyBuilder(BOPBlocks.CHISELED_BLACK_SANDSTONE)
            .fromManager(BiomesOPlentyBlocks.BOP_CHISELED_BLACK_SANDSTONE)
            .getFamily();

    public static final ModBlockFamily BOP_CHISELED_BRIMSTONE_BRICKS = familyBuilder(BOPBlocks.CHISELED_BRIMSTONE_BRICKS)
            .fromManager(BiomesOPlentyBlocks.BOP_CHISELED_BRIMSTONE_BRICK)
            .getFamily();

    public static final ModBlockFamily BOP_CHISELED_ORANGE_SANDSTONE = familyBuilder(BOPBlocks.CHISELED_ORANGE_SANDSTONE)
            .fromManager(BiomesOPlentyBlocks.BOP_CHISELED_ORANGE_SANDSTONE)
            .getFamily();

    public static final ModBlockFamily BOP_CHISELED_WHITE_SANDSTONE = familyBuilder(BOPBlocks.CHISELED_WHITE_SANDSTONE)
            .fromManager(BiomesOPlentyBlocks.BOP_CHISELED_WHITE_SANDSTONE)
            .getFamily();

    public static final ModBlockFamily BOP_CUT_BLACK_SANDSTONE = familyBuilder(BOPBlocks.CUT_BLACK_SANDSTONE)
            .fromManager(BiomesOPlentyBlocks.BOP_CUT_BLACK_SANDSTONE)
            .slab(BOPBlocks.CUT_BLACK_SANDSTONE_SLAB)
            .getFamily();

    public static final ModBlockFamily BOP_CUT_ORANGE_SANDSTONE = familyBuilder(BOPBlocks.CUT_ORANGE_SANDSTONE)
            .fromManager(BiomesOPlentyBlocks.BOP_CUT_ORANGE_SANDSTONE)
            .slab(BOPBlocks.CUT_ORANGE_SANDSTONE_SLAB)
            .getFamily();

    public static final ModBlockFamily BOP_CUT_WHITE_SANDSTONE = familyBuilder(BOPBlocks.CUT_WHITE_SANDSTONE)
            .fromManager(BiomesOPlentyBlocks.BOP_CUT_WHITE_SANDSTONE)
            .slab(BOPBlocks.CUT_WHITE_SANDSTONE_SLAB)
            .getFamily();

    public static final ModBlockFamily BOP_SMOOTH_BLACK_SANDSTONE = familyBuilder(BOPBlocks.SMOOTH_BLACK_SANDSTONE)
    ...
    public static final ModBlockFamily BOP_SMOOTH_ORANGE_SANDSTONE = familyBuilder(BOPBlocks.SMOOTH_ORANGE_SANDSTONE)
    ...
    public static final ModBlockFamily BOP_SMOOTH_WHITE_SANDSTONE = familyBuilder(BOPBlocks.SMOOTH_WHITE_SANDSTONE)
    ...
    /* Planks */
    public static final ModBlockFamily BOP_DEAD_PLANKS = familyBuilder(BOPBlocks.DEAD_PLANKS)
    ...
    public static final ModBlockFamily BOP_FIR_PLANKS = familyBuilder(BOPBlocks.FIR_PLANKS)
    ...
    public static final ModBlockFamily BOP_HELLBARK_PLANKS = familyBuilder(BOPBlocks.HELLBARK_PLANKS)
    ...
    public static final ModBlockFamily BOP_JACARANDA_PLANKS = familyBuilder(BOPBlocks.JACARANDA_PLANKS)
    ...
    public static final ModBlockFamily BOP_MAGIC_PLANKS = familyBuilder(BOPBlocks.MAGIC_PLANKS)
    ...
    public static final ModBlockFamily BOP_MAHOGANY_PLANKS = familyBuilder(BOPBlocks.MAHOGANY_PLANKS)
...
//    public static final ModBlockFamily BOP_MAPLE_PLANKS = familyBuilder(BOPBlocks.MAPLE_PLANKS)
...
//            .getFamily();
    ...
    public static final ModBlockFamily BOP_PALM_PLANKS = familyBuilder(BOPBlocks.PALM_PLANKS)
...
//    public static final ModBlockFamily BOP_PINE_PLANKS = familyBuilder(BOPBlocks.PINE_PLANKS)
...
//            .getFamily();
    ...
    public static final ModBlockFamily BOP_REDWOOD_PLANKS = familyBuilder(BOPBlocks.REDWOOD_PLANKS)
    ...
    public static final ModBlockFamily BOP_UMBRAN_PLANKS = familyBuilder(BOPBlocks.UMBRAN_PLANKS)
    ...
    public static final ModBlockFamily BOP_WILLOW_PLANKS = familyBuilder(BOPBlocks.WILLOW_PLANKS)
    ...
    /* Stripped Wood */
    public static final ModBlockFamily BOP_STRIPPED_DEAD_WOOD = familyBuilder(BOPBlocks.STRIPPED_DEAD_WOOD)
            .fromManager(BiomesOPlentyBlocks.BOP_STRIPPED_DEAD)
            .getFamily();
    
    public static final ModBlockFamily BOP_STRIPPED_FIR_WOOD = familyBuilder(BOPBlocks.STRIPPED_FIR_WOOD)
            .fromManager(BiomesOPlentyBlocks.BOP_STRIPPED_FIR)
            .getFamily();
    
    public static final ModBlockFamily BOP_STRIPPED_HELLBARK_WOOD = familyBuilder(BOPBlocks.STRIPPED_HELLBARK_WOOD)
            .fromManager(BiomesOPlentyBlocks.BOP_STRIPPED_HELLBARK)
            .getFamily();
    
    public static final ModBlockFamily BOP_STRIPPED_JACARANDA_WOOD = familyBuilder(BOPBlocks.STRIPPED_JACARANDA_WOOD)
            .fromManager(BiomesOPlentyBlocks.BOP_STRIPPED_JACARANDA)
            .getFamily();
    
    public static final ModBlockFamily BOP_STRIPPED_MAGIC_WOOD = familyBuilder(BOPBlocks.STRIPPED_MAGIC_WOOD)
            .fromManager(BiomesOPlentyBlocks.BOP_STRIPPED_MAGIC)
            .getFamily();
    
    public static final ModBlockFamily BOP_STRIPPED_MAHOGANY_WOOD = familyBuilder(BOPBlocks.STRIPPED_MAHOGANY_WOOD)
            .fromManager(BiomesOPlentyBlocks.BOP_STRIPPED_MAHOGANY)
            .getFamily();

//    public static final ModBlockFamily BOP_STRIPPED_MAPLE_WOOD = familyBuilder(BOPBlocks.STRIPPED_MAPLE_WOOD)
//            .fromManager(BiomesOPlentyBlocks.STRIPPED_MAPLE)
//            .getFamily();
    
    public static final ModBlockFamily BOP_STRIPPED_PALM_WOOD = familyBuilder(BOPBlocks.STRIPPED_PALM_WOOD)
            .fromManager(BiomesOPlentyBlocks.BOP_STRIPPED_PALM)
            .getFamily();

//    public static final ModBlockFamily BOP_STRIPPED_PINE_WOOD = familyBuilder(BOPBlocks.STRIPPED_PINE_WOOD)
//            .fromManager(BiomesOPlentyBlocks.STRIPPED_PINE)
//            .getFamily();
    
    public static final ModBlockFamily BOP_STRIPPED_REDWOOD_WOOD = familyBuilder(BOPBlocks.STRIPPED_REDWOOD_WOOD)
            .fromManager(BiomesOPlentyBlocks.BOP_STRIPPED_REDWOOD)
            .getFamily();
    
    public static final ModBlockFamily BOP_STRIPPED_UMBRAN_WOOD = familyBuilder(BOPBlocks.STRIPPED_UMBRAN_WOOD)
            .fromManager(BiomesOPlentyBlocks.BOP_STRIPPED_UMBRAN)
            .getFamily();
    
    public static final ModBlockFamily BOP_STRIPPED_WILLOW_WOOD = familyBuilder(BOPBlocks.STRIPPED_WILLOW_WOOD)
